...
muxOutput_w9 = operationOutput_w18 ? distance_array_0[6]:dbest_w14;
muxOutput_w8 = operationOutput_w18 ? knownClasses[6]:cbest_w6;

BestPointsClasses[index_w1] = muxOutput_w8;
BestPointsDistances[index_w1] = muxOutput_w9;
...
void knnFloat_8p128f_1Parallel_saveEnergy(float xFeatures[128], char knownClasses[8], float knownFeatures_0[8][128], char *out) {
// Step 2: Initialize local variables
