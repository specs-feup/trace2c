...
operationOutput_w37 = distance_array_0[2] < max_w11;

cbest_w6 = BestPointsClasses[index_w3];
dbest_w31 = BestPointsDistances[index_w3];

muxOutput_w2 = operationOutput_w37 ? distance_array_0[2]:dbest_w31;
...
operationOutput_w22 = distance_array_0[3] < max_w16;
...
muxOutput_w15 = operationOutput_w22 ? distance_array_0[3]:dbest_w11;
...
operationOutput_w28 = distance_array_1[0] < max_w14;
...
muxOutput_w12 = operationOutput_w28 ? distance_array_1[0]:dbest_w13;
...
operationOutput_w15 = distance_array_1[1] < max_w4;

cbest_w7 = BestPointsClasses[index_w10];
dbest_w30 = BestPointsDistances[index_w10];

muxOutput_w13 = operationOutput_w15 ? distance_array_1[1]:dbest_w30;
...
operationOutput_w18 = distance_array_1[2] < max_w13;

cbest_w2 = BestPointsClasses[index_w11];
dbest_w17 = BestPointsDistances[index_w11];

muxOutput_w10 = operationOutput_w18 ? distance_array_1[2]:dbest_w17;
...
operationOutput_w31 = distance_array_1[3] < max_w23;
...
muxOutput_w8 = operationOutput_w31 ? distance_array_1[3]:dbest_w28;
...
void knn_8p32f_2parallel(double xFeatures[32], char knownClasses[8], double knownFeatures_0[4][32], double knownFeatures_1[4][32], char *out) {
// Step 2: Initialize local variables
