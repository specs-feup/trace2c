...
void parallel_0(double knownFeatures[1][32], double xFeatures[32], double distance_array[1]) {
...
operationOutput_w11 = distance_array_1[0] < max_w6;
...
muxOutput_w9 = operationOutput_w11 ? distance_array_1[0]:dbest_w29;
...
operationOutput_w37 = distance_array_2[0] < max_w11;

cbest_w6 = BestPointsClasses[index_w3];
dbest_w31 = BestPointsDistances[index_w3];

muxOutput_w2 = operationOutput_w37 ? distance_array_2[0]:dbest_w31;
...
operationOutput_w22 = distance_array_3[0] < max_w16;
...
muxOutput_w15 = operationOutput_w22 ? distance_array_3[0]:dbest_w11;
...
operationOutput_w28 = distance_array_4[0] < max_w14;
...
muxOutput_w12 = operationOutput_w28 ? distance_array_4[0]:dbest_w13;
...
operationOutput_w15 = distance_array_5[0] < max_w4;

cbest_w7 = BestPointsClasses[index_w10];
dbest_w30 = BestPointsDistances[index_w10];

muxOutput_w13 = operationOutput_w15 ? distance_array_5[0]:dbest_w30;
...
operationOutput_w18 = distance_array_6[0] < max_w13;

cbest_w2 = BestPointsClasses[index_w11];
dbest_w17 = BestPointsDistances[index_w11];

muxOutput_w10 = operationOutput_w18 ? distance_array_6[0]:dbest_w17;
...
operationOutput_w31 = distance_array_7[0] < max_w23;
...
muxOutput_w8 = operationOutput_w31 ? distance_array_7[0]:dbest_w28;
...
void knn_8p32f_8parallel(double xFeatures[32], char knownClasses[8], double knownFeatures_0[1][32], double knownFeatures_1[1][32], double knownFeatures_2[1][32], double knownFeatures_3[1][32], double knownFeatures_4[1][32], double knownFeatures_5[1][32], double knownFeatures_6[1][32], double knownFeatures_7[1][32], char *out) {
// Step 2: Initialize local variables
...
#pragma HLS ARRAY_PARTITION variable=knownFeatures_4 cyclic factor=4 dim=2
#pragma HLS ARRAY_PARTITION variable=knownFeatures_5 cyclic factor=4 dim=2
#pragma HLS ARRAY_PARTITION variable=knownFeatures_6 cyclic factor=4 dim=2
#pragma HLS ARRAY_PARTITION variable=knownFeatures_7 cyclic factor=4 dim=2
// Initialization done
#pragma HLS dataflow
