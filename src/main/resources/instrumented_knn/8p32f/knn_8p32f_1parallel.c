...
operationOutput_w28 = distance_array_0[4] < max_w14;
...
muxOutput_w12 = operationOutput_w28 ? distance_array_0[4]:dbest_w13;
...
operationOutput_w15 = distance_array_0[5] < max_w4;

cbest_w7 = BestPointsClasses[index_w10];
dbest_w30 = BestPointsDistances[index_w10];

muxOutput_w13 = operationOutput_w15 ? distance_array_0[5]:dbest_w30;
...
operationOutput_w18 = distance_array_0[6] < max_w13;

cbest_w2 = BestPointsClasses[index_w11];
dbest_w17 = BestPointsDistances[index_w11];

muxOutput_w10 = operationOutput_w18 ? distance_array_0[6]:dbest_w17;
...
operationOutput_w31 = distance_array_0[7] < max_w23;
...
muxOutput_w8 = operationOutput_w31 ? distance_array_0[7]:dbest_w28;
...
void knn_8p32f_1parallel(double xFeatures[32], char knownClasses[8], double knownFeatures_0[8][32], char *out) {
// Step 2: Initialize local variables
