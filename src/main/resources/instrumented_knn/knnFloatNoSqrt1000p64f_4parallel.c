...
void parallel_0(float knownFeatures[250][64], float xFeatures[64], float distance_array[250])
{
...
void knnFloatNoSqrt1000p64f_4parallel(
    float xFeatures[64], char knownClasses0[250], char knownClasses1[250], char knownClasses2[250], char knownClasses3[250],
    float knownFeatures_0[250][64], float knownFeatures_1[250][64], float knownFeatures_2[250][64], float knownFeatures_3[250][64], char *out)
{
    // Step 2: Initialize local variables
