...
void parallel_0(float knownFeatures[5000][32], float xFeatures[32], float distances0_array[5000])
{
...
void knnNoEpilogue10000p32f(float xFeatures[32], char knownClasses0[5000], char knownClasses1[5000],
                            float knownFeatures_0[5000][32], float knownFeatures_1[5000][32], char *out)
{
    // Step 2: Initialize local variables
