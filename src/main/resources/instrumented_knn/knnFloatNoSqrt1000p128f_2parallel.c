...
void parallel_0(float knownFeatures[500][128], float xFeatures[128], float distance_array[500])
{
...
void knnFloatNoSqrt1000p128f_2parallel(
    float xFeatures[128], char knownClasses0[500], char knownClasses1[500],
    float knownFeatures_0[500][128], float knownFeatures_1[500][128], char *out)
{
    // Step 2: Initialize local variables
