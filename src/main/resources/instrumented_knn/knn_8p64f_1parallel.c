...
void parallel_0(double knownFeatures[8][64], double xFeatures[64], double distance_array[8]) {
...
operationOutput_w5 = distance_array_0[4] < max_w1;
...
muxOutput_w14 = operationOutput_w5 ? distance_array_0[4]:dbest_w23;
...
operationOutput_w14 = distance_array_0[5] < max_w17;

cbest_w8 = BestPointsClasses[index_w7];
dbest_w10 = BestPointsDistances[index_w7];

muxOutput_w5 = operationOutput_w14 ? distance_array_0[5]:dbest_w10;
...
operationOutput_w25 = distance_array_0[6] < max_w21;

cbest_w5 = BestPointsClasses[index_w11];
dbest_w31 = BestPointsDistances[index_w11];

muxOutput_w13 = operationOutput_w25 ? distance_array_0[6]:dbest_w31;
...
operationOutput_w20 = distance_array_0[7] < max_w13;

cbest_w4 = BestPointsClasses[index_w12];
dbest_w12 = BestPointsDistances[index_w12];

muxOutput_w8 = operationOutput_w20 ? distance_array_0[7]:dbest_w12;
...
void knn_8p64f_1parallel(double xFeatures[64], char knownClasses[8], double knownFeatures_0[8][64], char *out) {
// Step 2: Initialize local variables
