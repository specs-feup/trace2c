...
void parallel_0(double knownFeatures[2][128], double xFeatures[128], double distance_array[2]) {
...
operationOutput_w31 = distance_array_0[1] < max_w8;

cbest_w7 = BestPointsClasses[index_w2];
dbest_w29 = BestPointsDistances[index_w2];

muxOutput_w1 = operationOutput_w31 ? distance_array_0[1]:dbest_w29;
...
operationOutput_w1 = distance_array_1[0] < max_w1;
...
muxOutput_w5 = operationOutput_w1 ? distance_array_1[0]:dbest_w10;
...
operationOutput_w3 = distance_array_1[1] < max_w6;
...
muxOutput_w3 = operationOutput_w3 ? distance_array_1[1]:dbest_w4;
...
operationOutput_w24 = distance_array_2[0] < max_w20;
...
muxOutput_w11 = operationOutput_w24 ? distance_array_2[0]:dbest_w17;
...
operationOutput_w10 = distance_array_2[1] < max_w7;

cbest_w5 = BestPointsClasses[index_w11];
dbest_w22 = BestPointsDistances[index_w11];

muxOutput_w16 = operationOutput_w10 ? distance_array_2[1]:dbest_w22;
...
operationOutput_w18 = distance_array_3[0] < max_w4;
...
muxOutput_w8 = operationOutput_w18 ? distance_array_3[0]:dbest_w14;
...
operationOutput_w15 = distance_array_3[1] < max_w14;
...
muxOutput_w14 = operationOutput_w15 ? distance_array_3[1]:dbest_w2;
...
void knn_8p128f_4parallel(double xFeatures[128], char knownClasses[8], double knownFeatures_0[2][128], double knownFeatures_1[2][128], double knownFeatures_2[2][128], double knownFeatures_3[2][128], char *out) {
// Step 2: Initialize local variables
...
#pragma HLS ARRAY_PARTITION variable=knownFeatures_1 cyclic factor=32 dim=2
#pragma HLS ARRAY_PARTITION variable=knownFeatures_2 cyclic factor=32 dim=2
#pragma HLS ARRAY_PARTITION variable=knownFeatures_3 cyclic factor=32 dim=2
// Initialization done
#pragma HLS dataflow
