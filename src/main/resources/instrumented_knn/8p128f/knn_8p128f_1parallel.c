...
void parallel_0(double knownFeatures[8][128], double xFeatures[128], double distance_array[8]) {
...
void knn_8p128f_1parallel(double xFeatures[128], char knownClasses[8], double knownFeatures_0[8][128], char *out) {
// Step 2: Initialize local variables
