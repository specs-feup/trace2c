...
void parallel_0(float knownFeatures[250][32], float xFeatures[32], float distance_array[250])
{
...
#pragma HLS pipeline
        ...
        distance_w26 = 0 + sqr(temp_l77_i1_w1);
        distance_w4 = sqr(temp_l77_i28_w1) + sqr(temp_l77_i29_w1);
        distance_w31 = sqr(temp_l77_i30_w1) + sqr(temp_l77_i31_w1);

        distance_w24 = distance_w26 + sqr(temp_l77_i2_w1);
        distance_w3 = distance_w4 + distance_w31;

        distance_w23 = distance_w24 + sqr(temp_l77_i3_w1);

        distance_w29 = distance_w23 + sqr(temp_l77_i4_w1);

        distance_w22 = distance_w29 + sqr(temp_l77_i5_w1);
        ...
        distance_w28 = distance_w15 + sqr(temp_l77_i11_w1);

        distance_w27 = distance_w28 + sqr(temp_l77_i12_w1);

        distance_w14 = distance_w27 + sqr(temp_l77_i13_w1);
        ...
        distance_w30 = distance_w5 + sqr(temp_l77_i27_w1);

        distance_w25 = distance_w30 + distance_w3;

        distance_array[i] = distance_w25 + sqr(temp_l77_i32_w1);
    }
}
...
void knnFloatNoSqrt1000p32f_4parallel(
    float xFeatures[32], char knownClasses0[250], char knownClasses1[250], char knownClasses2[250], char knownClasses3[250],
    float knownFeatures_0[250][32], float knownFeatures_1[250][32], float knownFeatures_2[250][32], float knownFeatures_3[250][32], char *out)
{
    // Step 2: Initialize local variables
...
#pragma HLS ARRAY_PARTITION variable = knownFeatures_1 cyclic factor = 2 dim = 2
#pragma HLS ARRAY_PARTITION variable = knownFeatures_2 cyclic factor = 2 dim = 2
#pragma HLS ARRAY_PARTITION variable = knownFeatures_3 cyclic factor = 2 dim = 2
// Initialization done
#pragma HLS dataflow
