...
void parallel_0(double knownFeatures[1][64], double xFeatures[64], double distance_array[1]) {
...
operationOutput_w6 = distance_array_1[0] < max_w24;
...
muxOutput_w11 = operationOutput_w6 ? distance_array_1[0]:dbest_w22;
...
operationOutput_w4 = distance_array_2[0] < max_w20;
...
muxOutput_w3 = operationOutput_w4 ? distance_array_2[0]:dbest_w4;
...
operationOutput_w30 = distance_array_3[0] < max_w7;

cbest_w7 = BestPointsClasses[index_w1];
dbest_w32 = BestPointsDistances[index_w1];

muxOutput_w16 = operationOutput_w30 ? distance_array_3[0]:dbest_w32;
...
operationOutput_w5 = distance_array_4[0] < max_w1;
...
muxOutput_w14 = operationOutput_w5 ? distance_array_4[0]:dbest_w23;
...
operationOutput_w14 = distance_array_5[0] < max_w17;

cbest_w8 = BestPointsClasses[index_w7];
dbest_w10 = BestPointsDistances[index_w7];

muxOutput_w5 = operationOutput_w14 ? distance_array_5[0]:dbest_w10;
...
operationOutput_w25 = distance_array_6[0] < max_w21;

cbest_w5 = BestPointsClasses[index_w11];
dbest_w31 = BestPointsDistances[index_w11];

muxOutput_w13 = operationOutput_w25 ? distance_array_6[0]:dbest_w31;
...
operationOutput_w20 = distance_array_7[0] < max_w13;

cbest_w4 = BestPointsClasses[index_w12];
dbest_w12 = BestPointsDistances[index_w12];

muxOutput_w8 = operationOutput_w20 ? distance_array_7[0]:dbest_w12;
...
void knn_8p64f_8parallel(double xFeatures[64], char knownClasses[8], double knownFeatures_0[1][64], double knownFeatures_1[1][64], double knownFeatures_2[1][64], double knownFeatures_3[1][64], double knownFeatures_4[1][64], double knownFeatures_5[1][64], double knownFeatures_6[1][64], double knownFeatures_7[1][64], char *out) {
// Step 2: Initialize local variables
...
#pragma HLS ARRAY_PARTITION variable=knownFeatures_4 cyclic factor=8 dim=2
#pragma HLS ARRAY_PARTITION variable=knownFeatures_5 cyclic factor=8 dim=2
#pragma HLS ARRAY_PARTITION variable=knownFeatures_6 cyclic factor=8 dim=2
#pragma HLS ARRAY_PARTITION variable=knownFeatures_7 cyclic factor=8 dim=2
// Initialization done
#pragma HLS dataflow
