...
distance_w43 = distance_w73 + sqr(temp_l77_i18_w1);

distance_w4 = distance_w43 + sqr(temp_l77_i19_w1);

distance_w3 = distance_w4 + sqr(temp_l77_i20_w1);

distance_w105 = distance_w3 + sqr(temp_l77_i21_w1);
...
distance_w111 = distance_w90 + sqr(temp_l77_i54_w1);

distance_w116 = distance_w111 + sqr(temp_l77_i55_w1);

distance_w72 = distance_w116 + sqr(temp_l77_i56_w1);
...
distance_w112 = distance_w107 + sqr(temp_l77_i68_w1);

distance_w118 = distance_w112 + sqr(temp_l77_i69_w1);

distance_w117 = distance_w118 + sqr(temp_l77_i70_w1);

distance_w6 = distance_w117 + sqr(temp_l77_i71_w1);
...
distance_w20 = distance_w47 + sqr(temp_l77_i81_w1);

distance_w19 = distance_w20 + sqr(temp_l77_i82_w1);

distance_w114 = distance_w19 + sqr(temp_l77_i83_w1);

distance_w61 = distance_w114 + sqr(temp_l77_i84_w1);

distance_w60 = distance_w61 + sqr(temp_l77_i85_w1);

distance_w102 = distance_w60 + sqr(temp_l77_i86_w1);

distance_w34 = distance_w102 + sqr(temp_l77_i87_w1);

distance_w33 = distance_w34 + sqr(temp_l77_i88_w1);

distance_w68 = distance_w33 + sqr(temp_l77_i89_w1);

distance_w56 = distance_w68 + sqr(temp_l77_i90_w1);

distance_w10 = distance_w56 + sqr(temp_l77_i91_w1);

distance_w9 = distance_w10 + sqr(temp_l77_i92_w1);

distance_w113 = distance_w9 + sqr(temp_l77_i93_w1);

distance_w85 = distance_w113 + sqr(temp_l77_i94_w1);

distance_w84 = distance_w85 + sqr(temp_l77_i95_w1);

distance_w89 = distance_w84 + sqr(temp_l77_i96_w1);

distance_w82 = distance_w89 + sqr(temp_l77_i97_w1);

distance_w81 = distance_w82 + sqr(temp_l77_i98_w1);

distance_w100 = distance_w81 + sqr(temp_l77_i99_w1);

distance_w70 = distance_w100 + sqr(temp_l77_i100_w1);

distance_w69 = distance_w70 + sqr(temp_l77_i101_w1);

distance_w77 = distance_w69 + sqr(temp_l77_i102_w1);

distance_w28 = distance_w77 + sqr(temp_l77_i103_w1);

distance_w27 = distance_w28 + sqr(temp_l77_i104_w1);

distance_w50 = distance_w27 + sqr(temp_l77_i105_w1);

distance_w66 = distance_w50 + sqr(temp_l77_i106_w1);

distance_w110 = distance_w66 + sqr(temp_l77_i107_w1);

distance_w76 = distance_w110 + sqr(temp_l77_i108_w1);

distance_w75 = distance_w76 + sqr(temp_l77_i109_w1);

distance_w88 = distance_w75 + sqr(temp_l77_i110_w1);

distance_w87 = distance_w88 + sqr(temp_l77_i111_w1);

distance_w97 = distance_w87 + sqr(temp_l77_i112_w1);

distance_w124 = distance_w97 + sqr(temp_l77_i113_w1);

distance_w30 = distance_w124 + sqr(temp_l77_i114_w1);

distance_w29 = distance_w30 + sqr(temp_l77_i115_w1);

distance_w49 = distance_w29 + sqr(temp_l77_i116_w1);

distance_w48 = distance_w49 + sqr(temp_l77_i117_w1);

distance_w67 = distance_w48 + sqr(temp_l77_i118_w1);

distance_w54 = distance_w67 + sqr(temp_l77_i119_w1);

distance_w53 = distance_w54 + sqr(temp_l77_i120_w1);

distance_w86 = distance_w53 + sqr(temp_l77_i121_w1);

distance_w125 = distance_w86 + sqr(temp_l77_i122_w1);

distance_w98 = distance_w125 + sqr(temp_l77_i123_w1);

distance_w65 = distance_w98 + sqr(temp_l77_i124_w1);

distance_w64 = distance_w65 + sqr(temp_l77_i125_w1);

distance_w32 = distance_w64 + sqr(temp_l77_i126_w1);

distance_w31 = distance_w32 + sqr(temp_l77_i127_w1);

distance_array[i] = distance_w31 + sqr(temp_l77_i128_w1);
...
muxOutput_w4 = operationOutput_w3 ? knownClasses[0]:cbest_w1;
muxOutput_w3 = operationOutput_w3 ? distance_array_0[0]:dbest_w5;

BestPointsClasses[index_w7] = muxOutput_w4;
BestPointsDistances[index_w7] = muxOutput_w3;
...
operationOutput_w22 = dbest_w26 > max_tmp_w9;

index_w13 = operationOutput_w22 ? 1:index_w2;
max_w16 = operationOutput_w22 ? dbest_w26:max_w6;

max_tmp_w16 = max_w16;

operationOutput_w26 = dbest_w11 > max_tmp_w16;

max_w19 = operationOutput_w26 ? dbest_w11:max_w16;
...
muxOutput_w2 = operationOutput_w9 ? knownClasses[2]:cbest_w4;
...
max_w15 = operationOutput_w28 ? dbest_w27:max_w20;

max_tmp_w14 = max_w15;

operationOutput_w29 = dbest_w25 > max_tmp_w14;

index_w11 = operationOutput_w29 ? 2:index_w15;
max_w14 = operationOutput_w29 ? dbest_w25:max_w15;

operationOutput_w35 = distance_array_0[3] < max_w14;
...
operationOutput_w18 = distance_array_0[4] < max_w10;
...
muxOutput_w15 = operationOutput_w18 ? distance_array_0[4]:dbest_w31;
...
operationOutput_w20 = distance_array_0[5] < max_w7;

cbest_w5 = BestPointsClasses[index_w14];
dbest_w23 = BestPointsDistances[index_w14];

muxOutput_w14 = operationOutput_w20 ? distance_array_0[5]:dbest_w23;
...
operationOutput_w6 = distance_array_0[6] < max_w1;
...
muxOutput_w5 = operationOutput_w6 ? distance_array_0[6]:dbest_w6;

BestPointsDistances[index_w6] = muxOutput_w5;
...
operationOutput_w31 = distance_array_0[7] < max_w18;

cbest_w6 = BestPointsClasses[index_w17];
dbest_w29 = BestPointsDistances[index_w17];

muxOutput_w12 = operationOutput_w31 ? distance_array_0[7]:dbest_w29;
...
void knnFloatNoSqrt_8p128f_1parallel(float xFeatures[128], char knownClasses[8], float knownFeatures_0[8][128], char *out) {
// Step 2: Initialize local variables
