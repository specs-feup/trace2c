...
void knn_8p64f_4parallel(double xFeatures[64], char knownClasses[8], double knownFeatures_0[2][64], double knownFeatures_1[2][64], double knownFeatures_2[2][64], double knownFeatures_3[2][64], char *out) {
// Step 2: Initialize local variables
