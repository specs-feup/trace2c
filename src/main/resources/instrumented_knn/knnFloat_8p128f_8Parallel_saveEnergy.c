...
void parallel_0(float knownFeatures[1][128], float xFeatures[128], float distance_array[1]) {
...
void epilogue(char knownClasses[8], float distance_array_5[1], float distance_array_4[1], float distance_array_7[1], float distance_array_6[1], float distance_array_1[1], float distance_array_0[1], float distance_array_3[1], float distance_array_2[1], char *out) {
// Step 2: Initialize local variables
...
void knnFloat_8p128f_8Parallel_saveEnergy(float xFeatures[128], char knownClasses[8], float knownFeatures_0[1][128], float knownFeatures_1[1][128], float knownFeatures_2[1][128], float knownFeatures_3[1][128], float knownFeatures_4[1][128], float knownFeatures_5[1][128], float knownFeatures_6[1][128], float knownFeatures_7[1][128], char *out) {
// Step 2: Initialize local variables
float distance_array_0[1];
float distance_array_1[1];
float distance_array_2[1];
float distance_array_3[1];
float distance_array_4[1];
float distance_array_5[1];
float distance_array_6[1];
float distance_array_7[1];
