...
void parallel_0(float knownFeatures[8][128], float xFeatures[128], float distance_array[8]) {
...
void epilogue(char knownClasses[8], float distance_array_0[8], char *out) {
// Step 2: Initialize local variables
...
operationOutput_w24 = distance_array_0[4] < max_w20;
...
muxOutput_w11 = operationOutput_w24 ? distance_array_0[4]:dbest_w17;
...
operationOutput_w10 = distance_array_0[5] < max_w7;

cbest_w5 = BestPointsClasses[index_w11];
dbest_w22 = BestPointsDistances[index_w11];

muxOutput_w16 = operationOutput_w10 ? distance_array_0[5]:dbest_w22;
...
operationOutput_w18 = distance_array_0[6] < max_w4;
...
muxOutput_w8 = operationOutput_w18 ? distance_array_0[6]:dbest_w14;
...
operationOutput_w15 = distance_array_0[7] < max_w14;
...
muxOutput_w14 = operationOutput_w15 ? distance_array_0[7]:dbest_w2;
...
void knnFloat_8p128f_1Parallel(float xFeatures[128], char knownClasses[8], float knownFeatures_0[8][128], char *out) {
// Step 2: Initialize local variables
float distance_array_0[8];
#pragma HLS ARRAY_PARTITION variable=xFeatures cyclic factor=128 dim=1
#pragma HLS ARRAY_PARTITION variable=knownFeatures_0 cyclic factor=128 dim=2
// Initialization done
#pragma HLS dataflow
