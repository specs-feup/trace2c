...
void parallel_0(float knownFeatures[500][32], float xFeatures[32], float distance_array[500])
{
...
void knnFloatNoSqrt1000p32f_2parallel(
    float xFeatures[32], char knownClasses0[500],
    char knownClasses1[500], float knownFeatures_0[500][32],
    float knownFeatures_1[500][32], char *out)
{
    // Step 2: Initialize local variables
