...
void parallel_0(short x[2000], short y[2000], int sum_array[125]) {
...
void parallel_1(short x[1984], short y[1984], int sum_array[124]) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w11;
...
int sum_w8;
int sum_w9;
int temp_l83_i2014_w1;
int temp_l83_i2015_w1;
int temp_l83_i2016_w1;
int temp_l83_i2017_w1;
int temp_l83_i2018_w1;
int temp_l83_i2019_w1;
int temp_l83_i2020_w1;
int temp_l83_i2021_w1;
int temp_l83_i2022_w1;
int temp_l83_i2023_w1;
int temp_l83_i2024_w1;
int temp_l83_i2025_w1;
int temp_l83_i2026_w1;
int temp_l83_i2027_w1;
int temp_l83_i2028_w1;
int temp_l83_i2029_w1;
// Initialization done
// starting Loop
...
temp_l83_i2014_w1 = x[(16)*i] * y[(16)*i];
temp_l83_i2015_w1 = x[(16)*i+1] * y[(16)*i+1];
temp_l83_i2016_w1 = x[(16)*i+2] * y[(16)*i+2];
temp_l83_i2017_w1 = x[(16)*i+3] * y[(16)*i+3];
temp_l83_i2018_w1 = x[(16)*i+4] * y[(16)*i+4];
temp_l83_i2019_w1 = x[(16)*i+5] * y[(16)*i+5];
temp_l83_i2020_w1 = x[(16)*i+6] * y[(16)*i+6];
temp_l83_i2021_w1 = x[(16)*i+7] * y[(16)*i+7];
temp_l83_i2022_w1 = x[(16)*i+8] * y[(16)*i+8];
temp_l83_i2023_w1 = x[(16)*i+9] * y[(16)*i+9];
temp_l83_i2024_w1 = x[(16)*i+10] * y[(16)*i+10];
temp_l83_i2025_w1 = x[(16)*i+11] * y[(16)*i+11];
temp_l83_i2026_w1 = x[(16)*i+12] * y[(16)*i+12];
temp_l83_i2027_w1 = x[(16)*i+13] * y[(16)*i+13];
temp_l83_i2028_w1 = x[(16)*i+14] * y[(16)*i+14];
temp_l83_i2029_w1 = x[(16)*i+15] * y[(16)*i+15];

sum_w7 = temp_l83_i2014_w1 + temp_l83_i2015_w1;
sum_w8 = temp_l83_i2016_w1 + temp_l83_i2017_w1;
sum_w9 = temp_l83_i2018_w1 + temp_l83_i2019_w1;
sum_w10 = temp_l83_i2020_w1 + temp_l83_i2021_w1;
sum_w5 = temp_l83_i2022_w1 + temp_l83_i2023_w1;
sum_w6 = temp_l83_i2024_w1 + temp_l83_i2025_w1;
sum_w11 = temp_l83_i2026_w1 + temp_l83_i2027_w1;
sum_w12 = temp_l83_i2028_w1 + temp_l83_i2029_w1;

sum_w4 = sum_w11 + sum_w12;
sum_w3 = sum_w5 + sum_w6;
sum_w1 = sum_w7 + sum_w8;
sum_w2 = sum_w9 + sum_w10;

sum_w13 = sum_w1 + sum_w2;
sum_w14 = sum_w3 + sum_w4;
...
void epilogue(short x_0[13], short y_0[13], short y_3[3], short x_3[3], int sum_array_1[124], int sum_array_0[125], int *out) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w100;
...
sum_w83 = sum_array_0[82] + sum_array_0[83];
sum_w84 = sum_array_0[84] + sum_array_0[85];
sum_w47 = sum_array_0[86] + sum_array_0[87];
sum_w48 = sum_array_0[88] + sum_array_0[89];
sum_w173 = sum_array_0[90] + sum_array_0[91];
sum_w174 = sum_array_0[92] + sum_array_0[93];
sum_w199 = sum_array_0[94] + sum_array_0[95];
sum_w200 = sum_array_0[96] + sum_array_0[97];
sum_w171 = sum_array_0[98] + sum_array_0[99];
sum_w172 = sum_array_0[100] + sum_array_0[101];
sum_w214 = sum_array_0[102] + sum_array_0[103];
sum_w215 = sum_array_0[104] + sum_array_0[105];
sum_w5 = sum_array_0[106] + sum_array_0[107];
sum_w6 = sum_array_0[108] + sum_array_0[109];
sum_w129 = sum_array_0[110] + sum_array_0[111];
sum_w130 = sum_array_0[112] + sum_array_0[113];
sum_w127 = sum_array_0[114] + sum_array_0[115];
sum_w128 = sum_array_0[116] + sum_array_0[117];
sum_w157 = sum_array_0[118] + sum_array_0[119];
sum_w158 = sum_array_0[120] + sum_array_0[121];
sum_w131 = sum_array_0[122] + sum_array_0[123];
sum_w132 = sum_array_0[124] + sum_array_1[0];
sum_w101 = sum_array_1[1] + sum_array_1[2];
sum_w102 = sum_array_1[3] + sum_array_1[4];
sum_w17 = sum_array_1[5] + sum_array_1[6];
sum_w18 = sum_array_1[7] + sum_array_1[8];
sum_w201 = sum_array_1[9] + sum_array_1[10];
sum_w202 = sum_array_1[11] + sum_array_1[12];
sum_w145 = sum_array_1[13] + sum_array_1[14];
sum_w146 = sum_array_1[15] + sum_array_1[16];
sum_w203 = sum_array_1[17] + sum_array_1[18];
sum_w204 = sum_array_1[19] + sum_array_1[20];
sum_w35 = sum_array_1[21] + sum_array_1[22];
sum_w36 = sum_array_1[23] + sum_array_1[24];
sum_w261 = sum_array_1[25] + sum_array_1[26];
sum_w262 = sum_array_1[27] + sum_array_1[28];
sum_w239 = sum_array_1[29] + sum_array_1[30];
sum_w240 = sum_array_1[31] + sum_array_1[32];
sum_w189 = sum_array_1[33] + sum_array_1[34];
sum_w190 = sum_array_1[35] + sum_array_1[36];
sum_w218 = sum_array_1[37] + sum_array_1[38];
sum_w219 = sum_array_1[39] + sum_array_1[40];
sum_w67 = sum_array_1[41] + sum_array_1[42];
sum_w68 = sum_array_1[43] + sum_array_1[44];
sum_w259 = sum_array_1[45] + sum_array_1[46];
sum_w260 = sum_array_1[47] + sum_array_1[48];
sum_w85 = sum_array_1[49] + sum_array_1[50];
sum_w86 = sum_array_1[51] + sum_array_1[52];
sum_w167 = sum_array_1[53] + sum_array_1[54];
sum_w168 = sum_array_1[55] + sum_array_1[56];
sum_w87 = sum_array_1[57] + sum_array_1[58];
sum_w88 = sum_array_1[59] + sum_array_1[60];
sum_w237 = sum_array_1[61] + sum_array_1[62];
sum_w238 = sum_array_1[63] + sum_array_1[64];
sum_w117 = sum_array_1[65] + sum_array_1[66];
sum_w118 = sum_array_1[67] + sum_array_1[68];
sum_w81 = sum_array_1[69] + sum_array_1[70];
sum_w82 = sum_array_1[71] + sum_array_1[72];
sum_w109 = sum_array_1[73] + sum_array_1[74];
sum_w110 = sum_array_1[75] + sum_array_1[76];
sum_w75 = sum_array_1[77] + sum_array_1[78];
sum_w76 = sum_array_1[79] + sum_array_1[80];
sum_w11 = sum_array_1[81] + sum_array_1[82];
sum_w12 = sum_array_1[83] + sum_array_1[84];
sum_w137 = sum_array_1[85] + sum_array_1[86];
sum_w138 = sum_array_1[87] + sum_array_1[88];
sum_w37 = sum_array_1[89] + sum_array_1[90];
sum_w38 = sum_array_1[91] + sum_array_1[92];
sum_w253 = sum_array_1[93] + sum_array_1[94];
sum_w254 = sum_array_1[95] + sum_array_1[96];
sum_w183 = sum_array_1[97] + sum_array_1[98];
sum_w184 = sum_array_1[99] + sum_array_1[100];
sum_w89 = sum_array_1[101] + sum_array_1[102];
sum_w90 = sum_array_1[103] + sum_array_1[104];
sum_w73 = sum_array_1[105] + sum_array_1[106];
sum_w74 = sum_array_1[107] + sum_array_1[108];
sum_w39 = sum_array_1[109] + sum_array_1[110];
sum_w40 = sum_array_1[111] + sum_array_1[112];
sum_w161 = sum_array_1[113] + sum_array_1[114];
sum_w162 = sum_array_1[115] + sum_array_1[116];
sum_w165 = sum_array_1[117] + sum_array_1[118];
sum_w166 = sum_array_1[119] + sum_array_1[120];
sum_w241 = sum_array_1[121] + sum_array_1[122];
...
temp_l83_i3998_w1 = x_3[0] * y_3[0];
temp_l83_i3999_w1 = x_3[1] * y_3[1];
temp_l83_i4000_w1 = x_3[2] * y_3[2];
...
sum_w242 = sum_array_1[123] + sum_w232;
...
void n4000_maxNodes_100_dotprod_parallel2(short x_0[13], short x_1[2000], short x_2[1984], short x_3[3], short y_0[13], short y_1[2000], short y_2[1984], short y_3[3], int *out) {
// Step 2: Initialize local variables
int sum_array_0[125];
int sum_array_1[124];
