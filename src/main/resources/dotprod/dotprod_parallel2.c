...
void parallel_0(short x[992], short y[992], int width, int sum_array[62]) {
...
void epilogue(short x_0[13], short y_0[13], short x_3[3], short y_3[3], int sum_array_0[62], int sum_array_1[62], int *out) {
// Step 2: Initialize local variables
int temp_l83_i13_w1;
int temp_l83_i12_w1;
int sum_w1;
...
void dotprod_parallel2(short x_0[13], short x_1[992], short x_2[992], short x_3[3], short y_0[13], short y_1[992], short y_2[992], short y_3[3], int *out) {
// Step 2: Initialize local variables
int sum_array_0[62];
int sum_array_1[62];
#pragma HLS ARRAY_PARTITION variable=x_0 cyclic factor=13 dim=0
...
parallel_0(x_1,y_1,62,sum_array_0);
parallel_0(x_2,y_2,62,sum_array_1);


epilogue(x_0,y_0,x_3,y_3,sum_array_0,sum_array_1,out);
