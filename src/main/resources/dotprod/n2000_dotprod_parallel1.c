...
void parallel_0(short x[1984], short y[1984], int sum_array[124]) {
...
void epilogue(short x_0[13], short x_2[3], short y_0[13], short y_2[3], int sum_array_0[124], int *out) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w100;
...
sum_w84 = sum_array_0[62] + sum_array_0[63];
sum_w85 = sum_array_0[64] + sum_array_0[65];
sum_w41 = sum_array_0[66] + sum_array_0[67];
sum_w42 = sum_array_0[68] + sum_array_0[69];
sum_w39 = sum_array_0[70] + sum_array_0[71];
sum_w40 = sum_array_0[72] + sum_array_0[73];
sum_w35 = sum_array_0[74] + sum_array_0[75];
sum_w36 = sum_array_0[76] + sum_array_0[77];
sum_w49 = sum_array_0[78] + sum_array_0[79];
sum_w50 = sum_array_0[80] + sum_array_0[81];
sum_w112 = sum_array_0[82] + sum_array_0[83];
sum_w113 = sum_array_0[84] + sum_array_0[85];
sum_w63 = sum_array_0[86] + sum_array_0[87];
sum_w64 = sum_array_0[88] + sum_array_0[89];
sum_w55 = sum_array_0[90] + sum_array_0[91];
sum_w56 = sum_array_0[92] + sum_array_0[93];
sum_w77 = sum_array_0[94] + sum_array_0[95];
sum_w78 = sum_array_0[96] + sum_array_0[97];
sum_w53 = sum_array_0[98] + sum_array_0[99];
sum_w54 = sum_array_0[100] + sum_array_0[101];
sum_w88 = sum_array_0[102] + sum_array_0[103];
sum_w89 = sum_array_0[104] + sum_array_0[105];
sum_w5 = sum_array_0[106] + sum_array_0[107];
sum_w6 = sum_array_0[108] + sum_array_0[109];
sum_w17 = sum_array_0[110] + sum_array_0[111];
sum_w18 = sum_array_0[112] + sum_array_0[113];
sum_w13 = sum_array_0[114] + sum_array_0[115];
sum_w14 = sum_array_0[116] + sum_array_0[117];
sum_w45 = sum_array_0[118] + sum_array_0[119];
sum_w46 = sum_array_0[120] + sum_array_0[121];
sum_w16 = sum_array_0[122] + sum_array_0[123];
...
temp_l83_i1998_w1 = x_2[0] * y_2[0];
temp_l83_i1999_w1 = x_2[1] * y_2[1];
temp_l83_i2000_w1 = x_2[2] * y_2[2];
...
void dotprod_parallel1(short y_0[13], short y_1[1984], short y_2[3], short x_0[13], short x_1[1984], short x_2[3], int *out) {
// Step 2: Initialize local variables
int sum_array_0[124];
...
#pragma HLS ARRAY_PARTITION variable=y_2 cyclic factor=3 dim=0
...
#pragma HLS ARRAY_PARTITION variable=x_2 cyclic factor=3 dim=0
