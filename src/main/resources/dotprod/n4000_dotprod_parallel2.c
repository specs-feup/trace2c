...
void parallel_0(short x[1984], short y[1984], int sum_array[31]) {
...
void parallel_1(short x[1920], short y[1920], int sum_array[30]) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w11;
...
int sum_w8;
int sum_w9;
int temp_l83_i2030_w1;
int temp_l83_i2031_w1;
int temp_l83_i2032_w1;
int temp_l83_i2033_w1;
int temp_l83_i2034_w1;
int temp_l83_i2035_w1;
int temp_l83_i2036_w1;
int temp_l83_i2037_w1;
int temp_l83_i2038_w1;
int temp_l83_i2039_w1;
int temp_l83_i2040_w1;
int temp_l83_i2041_w1;
int temp_l83_i2042_w1;
int temp_l83_i2043_w1;
int temp_l83_i2044_w1;
int temp_l83_i2045_w1;
int temp_l83_i2046_w1;
int temp_l83_i2047_w1;
int temp_l83_i2048_w1;
int temp_l83_i2049_w1;
int temp_l83_i2050_w1;
int temp_l83_i2051_w1;
int temp_l83_i2052_w1;
int temp_l83_i2053_w1;
int temp_l83_i2054_w1;
int temp_l83_i2055_w1;
int temp_l83_i2056_w1;
int temp_l83_i2057_w1;
int temp_l83_i2058_w1;
int temp_l83_i2059_w1;
int temp_l83_i2060_w1;
int temp_l83_i2061_w1;
int temp_l83_i2062_w1;
int temp_l83_i2063_w1;
int temp_l83_i2064_w1;
int temp_l83_i2065_w1;
int temp_l83_i2066_w1;
int temp_l83_i2067_w1;
int temp_l83_i2068_w1;
int temp_l83_i2069_w1;
int temp_l83_i2070_w1;
int temp_l83_i2071_w1;
int temp_l83_i2072_w1;
int temp_l83_i2073_w1;
int temp_l83_i2074_w1;
int temp_l83_i2075_w1;
int temp_l83_i2076_w1;
int temp_l83_i2077_w1;
int temp_l83_i2078_w1;
int temp_l83_i2079_w1;
int temp_l83_i2080_w1;
int temp_l83_i2081_w1;
int temp_l83_i2082_w1;
int temp_l83_i2083_w1;
int temp_l83_i2084_w1;
int temp_l83_i2085_w1;
int temp_l83_i2086_w1;
int temp_l83_i2087_w1;
int temp_l83_i2088_w1;
int temp_l83_i2089_w1;
int temp_l83_i2090_w1;
int temp_l83_i2091_w1;
int temp_l83_i2092_w1;
int temp_l83_i2093_w1;
// Initialization done
// starting Loop
...
temp_l83_i2030_w1 = x[(64)*i] * y[(64)*i];
temp_l83_i2031_w1 = x[(64)*i+1] * y[(64)*i+1];
temp_l83_i2032_w1 = x[(64)*i+2] * y[(64)*i+2];
temp_l83_i2033_w1 = x[(64)*i+3] * y[(64)*i+3];
temp_l83_i2034_w1 = x[(64)*i+4] * y[(64)*i+4];
temp_l83_i2035_w1 = x[(64)*i+5] * y[(64)*i+5];
temp_l83_i2036_w1 = x[(64)*i+6] * y[(64)*i+6];
temp_l83_i2037_w1 = x[(64)*i+7] * y[(64)*i+7];
temp_l83_i2038_w1 = x[(64)*i+8] * y[(64)*i+8];
temp_l83_i2039_w1 = x[(64)*i+9] * y[(64)*i+9];
temp_l83_i2040_w1 = x[(64)*i+10] * y[(64)*i+10];
temp_l83_i2041_w1 = x[(64)*i+11] * y[(64)*i+11];
temp_l83_i2042_w1 = x[(64)*i+12] * y[(64)*i+12];
temp_l83_i2043_w1 = x[(64)*i+13] * y[(64)*i+13];
temp_l83_i2044_w1 = x[(64)*i+14] * y[(64)*i+14];
temp_l83_i2045_w1 = x[(64)*i+15] * y[(64)*i+15];
temp_l83_i2046_w1 = x[(64)*i+16] * y[(64)*i+16];
temp_l83_i2047_w1 = x[(64)*i+17] * y[(64)*i+17];
temp_l83_i2048_w1 = x[(64)*i+18] * y[(64)*i+18];
temp_l83_i2049_w1 = x[(64)*i+19] * y[(64)*i+19];
temp_l83_i2050_w1 = x[(64)*i+20] * y[(64)*i+20];
temp_l83_i2051_w1 = x[(64)*i+21] * y[(64)*i+21];
temp_l83_i2052_w1 = x[(64)*i+22] * y[(64)*i+22];
temp_l83_i2053_w1 = x[(64)*i+23] * y[(64)*i+23];
temp_l83_i2054_w1 = x[(64)*i+24] * y[(64)*i+24];
temp_l83_i2055_w1 = x[(64)*i+25] * y[(64)*i+25];
temp_l83_i2056_w1 = x[(64)*i+26] * y[(64)*i+26];
temp_l83_i2057_w1 = x[(64)*i+27] * y[(64)*i+27];
temp_l83_i2058_w1 = x[(64)*i+28] * y[(64)*i+28];
temp_l83_i2059_w1 = x[(64)*i+29] * y[(64)*i+29];
temp_l83_i2060_w1 = x[(64)*i+30] * y[(64)*i+30];
temp_l83_i2061_w1 = x[(64)*i+31] * y[(64)*i+31];
temp_l83_i2062_w1 = x[(64)*i+32] * y[(64)*i+32];
temp_l83_i2063_w1 = x[(64)*i+33] * y[(64)*i+33];
temp_l83_i2064_w1 = x[(64)*i+34] * y[(64)*i+34];
temp_l83_i2065_w1 = x[(64)*i+35] * y[(64)*i+35];
temp_l83_i2066_w1 = x[(64)*i+36] * y[(64)*i+36];
temp_l83_i2067_w1 = x[(64)*i+37] * y[(64)*i+37];
temp_l83_i2068_w1 = x[(64)*i+38] * y[(64)*i+38];
temp_l83_i2069_w1 = x[(64)*i+39] * y[(64)*i+39];
temp_l83_i2070_w1 = x[(64)*i+40] * y[(64)*i+40];
temp_l83_i2071_w1 = x[(64)*i+41] * y[(64)*i+41];
temp_l83_i2072_w1 = x[(64)*i+42] * y[(64)*i+42];
temp_l83_i2073_w1 = x[(64)*i+43] * y[(64)*i+43];
temp_l83_i2074_w1 = x[(64)*i+44] * y[(64)*i+44];
temp_l83_i2075_w1 = x[(64)*i+45] * y[(64)*i+45];
temp_l83_i2076_w1 = x[(64)*i+46] * y[(64)*i+46];
temp_l83_i2077_w1 = x[(64)*i+47] * y[(64)*i+47];
temp_l83_i2078_w1 = x[(64)*i+48] * y[(64)*i+48];
temp_l83_i2079_w1 = x[(64)*i+49] * y[(64)*i+49];
temp_l83_i2080_w1 = x[(64)*i+50] * y[(64)*i+50];
temp_l83_i2081_w1 = x[(64)*i+51] * y[(64)*i+51];
temp_l83_i2082_w1 = x[(64)*i+52] * y[(64)*i+52];
temp_l83_i2083_w1 = x[(64)*i+53] * y[(64)*i+53];
temp_l83_i2084_w1 = x[(64)*i+54] * y[(64)*i+54];
temp_l83_i2085_w1 = x[(64)*i+55] * y[(64)*i+55];
temp_l83_i2086_w1 = x[(64)*i+56] * y[(64)*i+56];
temp_l83_i2087_w1 = x[(64)*i+57] * y[(64)*i+57];
temp_l83_i2088_w1 = x[(64)*i+58] * y[(64)*i+58];
temp_l83_i2089_w1 = x[(64)*i+59] * y[(64)*i+59];
temp_l83_i2090_w1 = x[(64)*i+60] * y[(64)*i+60];
temp_l83_i2091_w1 = x[(64)*i+61] * y[(64)*i+61];
temp_l83_i2092_w1 = x[(64)*i+62] * y[(64)*i+62];
temp_l83_i2093_w1 = x[(64)*i+63] * y[(64)*i+63];

sum_w35 = temp_l83_i2030_w1 + temp_l83_i2031_w1;
sum_w36 = temp_l83_i2032_w1 + temp_l83_i2033_w1;
sum_w41 = temp_l83_i2034_w1 + temp_l83_i2035_w1;
sum_w42 = temp_l83_i2036_w1 + temp_l83_i2037_w1;
sum_w23 = temp_l83_i2038_w1 + temp_l83_i2039_w1;
sum_w24 = temp_l83_i2040_w1 + temp_l83_i2041_w1;
sum_w19 = temp_l83_i2042_w1 + temp_l83_i2043_w1;
sum_w20 = temp_l83_i2044_w1 + temp_l83_i2045_w1;
sum_w17 = temp_l83_i2046_w1 + temp_l83_i2047_w1;
sum_w18 = temp_l83_i2048_w1 + temp_l83_i2049_w1;
sum_w55 = temp_l83_i2050_w1 + temp_l83_i2051_w1;
sum_w56 = temp_l83_i2052_w1 + temp_l83_i2053_w1;
sum_w7 = temp_l83_i2054_w1 + temp_l83_i2055_w1;
sum_w8 = temp_l83_i2056_w1 + temp_l83_i2057_w1;
sum_w9 = temp_l83_i2058_w1 + temp_l83_i2059_w1;
sum_w10 = temp_l83_i2060_w1 + temp_l83_i2061_w1;
sum_w21 = temp_l83_i2062_w1 + temp_l83_i2063_w1;
sum_w22 = temp_l83_i2064_w1 + temp_l83_i2065_w1;
sum_w47 = temp_l83_i2066_w1 + temp_l83_i2067_w1;
sum_w48 = temp_l83_i2068_w1 + temp_l83_i2069_w1;
sum_w3 = temp_l83_i2070_w1 + temp_l83_i2071_w1;
sum_w4 = temp_l83_i2072_w1 + temp_l83_i2073_w1;
sum_w5 = temp_l83_i2074_w1 + temp_l83_i2075_w1;
sum_w6 = temp_l83_i2076_w1 + temp_l83_i2077_w1;
sum_w61 = temp_l83_i2078_w1 + temp_l83_i2079_w1;
sum_w62 = temp_l83_i2080_w1 + temp_l83_i2081_w1;
sum_w1 = temp_l83_i2082_w1 + temp_l83_i2083_w1;
sum_w2 = temp_l83_i2084_w1 + temp_l83_i2085_w1;
sum_w49 = temp_l83_i2086_w1 + temp_l83_i2087_w1;
sum_w50 = temp_l83_i2088_w1 + temp_l83_i2089_w1;
sum_w11 = temp_l83_i2090_w1 + temp_l83_i2091_w1;
sum_w12 = temp_l83_i2092_w1 + temp_l83_i2093_w1;

sum_w14 = sum_w1 + sum_w2;
sum_w46 = sum_w11 + sum_w12;
sum_w39 = sum_w17 + sum_w18;
sum_w52 = sum_w19 + sum_w20;
sum_w37 = sum_w21 + sum_w22;
sum_w51 = sum_w23 + sum_w24;
sum_w25 = sum_w3 + sum_w4;
sum_w59 = sum_w35 + sum_w36;
sum_w60 = sum_w41 + sum_w42;
sum_w38 = sum_w47 + sum_w48;
sum_w45 = sum_w49 + sum_w50;
sum_w26 = sum_w5 + sum_w6;
sum_w40 = sum_w55 + sum_w56;
sum_w13 = sum_w61 + sum_w62;
sum_w43 = sum_w7 + sum_w8;
sum_w44 = sum_w9 + sum_w10;

sum_w33 = sum_w13 + sum_w14;
sum_w28 = sum_w25 + sum_w26;
sum_w27 = sum_w37 + sum_w38;
sum_w31 = sum_w39 + sum_w40;
sum_w32 = sum_w43 + sum_w44;
sum_w34 = sum_w45 + sum_w46;
sum_w54 = sum_w51 + sum_w52;
sum_w53 = sum_w59 + sum_w60;

sum_w29 = sum_w27 + sum_w28;
sum_w16 = sum_w31 + sum_w32;
sum_w30 = sum_w33 + sum_w34;
sum_w15 = sum_w53 + sum_w54;

sum_w57 = sum_w15 + sum_w16;
sum_w58 = sum_w29 + sum_w30;
...
void epilogue(short x_0[45], short y_0[45], short y_3[51], short x_3[51], int sum_array_1[30], int sum_array_0[31], int *out) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w100;
...
sum_w83 = sum_array_0[30] + sum_array_1[0];
sum_w41 = sum_array_1[1] + sum_array_1[2];
sum_w42 = sum_array_1[3] + sum_array_1[4];
sum_w31 = sum_array_1[5] + sum_array_1[6];
sum_w32 = sum_array_1[7] + sum_array_1[8];
sum_w115 = sum_array_1[9] + sum_array_1[10];
sum_w116 = sum_array_1[11] + sum_array_1[12];
sum_w113 = sum_array_1[13] + sum_array_1[14];
sum_w114 = sum_array_1[15] + sum_array_1[16];
sum_w125 = sum_array_1[17] + sum_array_1[18];
sum_w126 = sum_array_1[19] + sum_array_1[20];
sum_w104 = sum_array_1[21] + sum_array_1[22];
sum_w105 = sum_array_1[23] + sum_array_1[24];
sum_w29 = sum_array_1[25] + sum_array_1[26];
sum_w30 = sum_array_1[27] + sum_array_1[28];
...
temp_l83_i3950_w1 = x_3[0] * y_3[0];
temp_l83_i3951_w1 = x_3[1] * y_3[1];
temp_l83_i3952_w1 = x_3[2] * y_3[2];
temp_l83_i3953_w1 = x_3[3] * y_3[3];
temp_l83_i3954_w1 = x_3[4] * y_3[4];
temp_l83_i3955_w1 = x_3[5] * y_3[5];
temp_l83_i3956_w1 = x_3[6] * y_3[6];
temp_l83_i3957_w1 = x_3[7] * y_3[7];
temp_l83_i3958_w1 = x_3[8] * y_3[8];
temp_l83_i3959_w1 = x_3[9] * y_3[9];
temp_l83_i3960_w1 = x_3[10] * y_3[10];
temp_l83_i3961_w1 = x_3[11] * y_3[11];
temp_l83_i3962_w1 = x_3[12] * y_3[12];
temp_l83_i3963_w1 = x_3[13] * y_3[13];
temp_l83_i3964_w1 = x_3[14] * y_3[14];
temp_l83_i3965_w1 = x_3[15] * y_3[15];
temp_l83_i3966_w1 = x_3[16] * y_3[16];
temp_l83_i3967_w1 = x_3[17] * y_3[17];
temp_l83_i3968_w1 = x_3[18] * y_3[18];
temp_l83_i3969_w1 = x_3[19] * y_3[19];
temp_l83_i3970_w1 = x_3[20] * y_3[20];
temp_l83_i3971_w1 = x_3[21] * y_3[21];
temp_l83_i3972_w1 = x_3[22] * y_3[22];
temp_l83_i3973_w1 = x_3[23] * y_3[23];
temp_l83_i3974_w1 = x_3[24] * y_3[24];
temp_l83_i3975_w1 = x_3[25] * y_3[25];
temp_l83_i3976_w1 = x_3[26] * y_3[26];
temp_l83_i3977_w1 = x_3[27] * y_3[27];
temp_l83_i3978_w1 = x_3[28] * y_3[28];
temp_l83_i3979_w1 = x_3[29] * y_3[29];
temp_l83_i3980_w1 = x_3[30] * y_3[30];
temp_l83_i3981_w1 = x_3[31] * y_3[31];
temp_l83_i3982_w1 = x_3[32] * y_3[32];
temp_l83_i3983_w1 = x_3[33] * y_3[33];
temp_l83_i3984_w1 = x_3[34] * y_3[34];
temp_l83_i3985_w1 = x_3[35] * y_3[35];
temp_l83_i3986_w1 = x_3[36] * y_3[36];
temp_l83_i3987_w1 = x_3[37] * y_3[37];
temp_l83_i3988_w1 = x_3[38] * y_3[38];
temp_l83_i3989_w1 = x_3[39] * y_3[39];
temp_l83_i3990_w1 = x_3[40] * y_3[40];
temp_l83_i3991_w1 = x_3[41] * y_3[41];
temp_l83_i3992_w1 = x_3[42] * y_3[42];
temp_l83_i3993_w1 = x_3[43] * y_3[43];
temp_l83_i3994_w1 = x_3[44] * y_3[44];
temp_l83_i3995_w1 = x_3[45] * y_3[45];
temp_l83_i3996_w1 = x_3[46] * y_3[46];
temp_l83_i3997_w1 = x_3[47] * y_3[47];
temp_l83_i3998_w1 = x_3[48] * y_3[48];
temp_l83_i3999_w1 = x_3[49] * y_3[49];
temp_l83_i4000_w1 = x_3[50] * y_3[50];
...
sum_w68 = sum_array_1[29] + sum_w55;
...
void n4000_dotprod_parallel2(short x_0[45], short x_1[1984], short x_2[1920], short x_3[51], short y_0[45], short y_1[1984], short y_2[1920], short y_3[51], int *out) {
// Step 2: Initialize local variables
int sum_array_0[31];
int sum_array_1[30];
...
#pragma HLS ARRAY_PARTITION variable=x_3 cyclic factor=51 dim=0
...
#pragma HLS ARRAY_PARTITION variable=y_3 cyclic factor=51 dim=0
...
parallel_1(x_2,y_2,sum_array_1);
