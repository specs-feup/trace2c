...
void parallel_0(short x[331], short y[331], int width, int sum_array[21]) {
...
void epilogue(short x_0[13], short y_0[13], short x_7[3], short y_7[3], int sum_array_1[21], int sum_array_2[21], int sum_array_0[21], int sum_array_5[21], int sum_array_4[21], int sum_array_3[21], int *out) {
// Step 2: Initialize local variables
int temp_l83_i13_w1;
int temp_l83_i12_w1;
int sum_w1;
...
void dotprod_parallel2N500(short x_0[13], short x_1[331], short x_2[331], short x_3[331], short x_4[331], short x_5[331], short x_6[331], short x_7[3], short y_0[13], short y_1[331], short y_2[331], short y_3[331], short y_4[331], short y_5[331], short y_6[331], short y_7[3], int *out) {
// Step 2: Initialize local variables
int sum_array_0[21];
int sum_array_1[21];
int sum_array_2[21];
...
parallel_0(x_1,y_1,21,sum_array_0);
parallel_0(x_2,y_2,21,sum_array_1);
parallel_0(x_3,y_3,21,sum_array_2);
parallel_0(x_4,y_4,21,sum_array_3);
parallel_0(x_5,y_5,21,sum_array_4);
parallel_0(x_6,y_6,19,sum_array_5);


epilogue(x_0,y_0,x_7,y_7,sum_array_1,sum_array_2,sum_array_0,sum_array_5,sum_array_4,sum_array_3,out);
