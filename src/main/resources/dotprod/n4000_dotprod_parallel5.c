...
void parallel_0(short x[832], short y[832], int sum_array[13]) {
...
void parallel_1(short x[576], short y[576], int sum_array[9]) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w11;
...
int temp_l83_i3390_w1;
int temp_l83_i3391_w1;
int temp_l83_i3392_w1;
int temp_l83_i3393_w1;
int temp_l83_i3394_w1;
int temp_l83_i3395_w1;
int temp_l83_i3396_w1;
int temp_l83_i3397_w1;
int temp_l83_i3398_w1;
int temp_l83_i3399_w1;
int temp_l83_i3400_w1;
int temp_l83_i3401_w1;
int temp_l83_i3402_w1;
int temp_l83_i3403_w1;
int temp_l83_i3404_w1;
int temp_l83_i3405_w1;
int temp_l83_i3406_w1;
int temp_l83_i3407_w1;
int temp_l83_i3408_w1;
int temp_l83_i3409_w1;
int temp_l83_i3410_w1;
int temp_l83_i3411_w1;
int temp_l83_i3412_w1;
int temp_l83_i3413_w1;
int temp_l83_i3414_w1;
int temp_l83_i3415_w1;
int temp_l83_i3416_w1;
int temp_l83_i3417_w1;
int temp_l83_i3418_w1;
int temp_l83_i3419_w1;
int temp_l83_i3420_w1;
int temp_l83_i3421_w1;
int temp_l83_i3422_w1;
int temp_l83_i3423_w1;
int temp_l83_i3424_w1;
int temp_l83_i3425_w1;
int temp_l83_i3426_w1;
int temp_l83_i3427_w1;
int temp_l83_i3428_w1;
int temp_l83_i3429_w1;
int temp_l83_i3430_w1;
int temp_l83_i3431_w1;
int temp_l83_i3432_w1;
int temp_l83_i3433_w1;
int temp_l83_i3434_w1;
int temp_l83_i3435_w1;
int temp_l83_i3436_w1;
int temp_l83_i3437_w1;
// Initialization done
// starting Loop
...
temp_l83_i3374_w1 = x[(64)*i] * y[(64)*i];
temp_l83_i3375_w1 = x[(64)*i+1] * y[(64)*i+1];
temp_l83_i3376_w1 = x[(64)*i+2] * y[(64)*i+2];
temp_l83_i3377_w1 = x[(64)*i+3] * y[(64)*i+3];
temp_l83_i3378_w1 = x[(64)*i+4] * y[(64)*i+4];
temp_l83_i3379_w1 = x[(64)*i+5] * y[(64)*i+5];
temp_l83_i3380_w1 = x[(64)*i+6] * y[(64)*i+6];
temp_l83_i3381_w1 = x[(64)*i+7] * y[(64)*i+7];
temp_l83_i3382_w1 = x[(64)*i+8] * y[(64)*i+8];
temp_l83_i3383_w1 = x[(64)*i+9] * y[(64)*i+9];
temp_l83_i3384_w1 = x[(64)*i+10] * y[(64)*i+10];
temp_l83_i3385_w1 = x[(64)*i+11] * y[(64)*i+11];
temp_l83_i3386_w1 = x[(64)*i+12] * y[(64)*i+12];
temp_l83_i3387_w1 = x[(64)*i+13] * y[(64)*i+13];
temp_l83_i3388_w1 = x[(64)*i+14] * y[(64)*i+14];
temp_l83_i3389_w1 = x[(64)*i+15] * y[(64)*i+15];
temp_l83_i3390_w1 = x[(64)*i+16] * y[(64)*i+16];
temp_l83_i3391_w1 = x[(64)*i+17] * y[(64)*i+17];
temp_l83_i3392_w1 = x[(64)*i+18] * y[(64)*i+18];
temp_l83_i3393_w1 = x[(64)*i+19] * y[(64)*i+19];
temp_l83_i3394_w1 = x[(64)*i+20] * y[(64)*i+20];
temp_l83_i3395_w1 = x[(64)*i+21] * y[(64)*i+21];
temp_l83_i3396_w1 = x[(64)*i+22] * y[(64)*i+22];
temp_l83_i3397_w1 = x[(64)*i+23] * y[(64)*i+23];
temp_l83_i3398_w1 = x[(64)*i+24] * y[(64)*i+24];
temp_l83_i3399_w1 = x[(64)*i+25] * y[(64)*i+25];
temp_l83_i3400_w1 = x[(64)*i+26] * y[(64)*i+26];
temp_l83_i3401_w1 = x[(64)*i+27] * y[(64)*i+27];
temp_l83_i3402_w1 = x[(64)*i+28] * y[(64)*i+28];
temp_l83_i3403_w1 = x[(64)*i+29] * y[(64)*i+29];
temp_l83_i3404_w1 = x[(64)*i+30] * y[(64)*i+30];
temp_l83_i3405_w1 = x[(64)*i+31] * y[(64)*i+31];
temp_l83_i3406_w1 = x[(64)*i+32] * y[(64)*i+32];
temp_l83_i3407_w1 = x[(64)*i+33] * y[(64)*i+33];
temp_l83_i3408_w1 = x[(64)*i+34] * y[(64)*i+34];
temp_l83_i3409_w1 = x[(64)*i+35] * y[(64)*i+35];
temp_l83_i3410_w1 = x[(64)*i+36] * y[(64)*i+36];
temp_l83_i3411_w1 = x[(64)*i+37] * y[(64)*i+37];
temp_l83_i3412_w1 = x[(64)*i+38] * y[(64)*i+38];
temp_l83_i3413_w1 = x[(64)*i+39] * y[(64)*i+39];
temp_l83_i3414_w1 = x[(64)*i+40] * y[(64)*i+40];
temp_l83_i3415_w1 = x[(64)*i+41] * y[(64)*i+41];
temp_l83_i3416_w1 = x[(64)*i+42] * y[(64)*i+42];
temp_l83_i3417_w1 = x[(64)*i+43] * y[(64)*i+43];
temp_l83_i3418_w1 = x[(64)*i+44] * y[(64)*i+44];
temp_l83_i3419_w1 = x[(64)*i+45] * y[(64)*i+45];
temp_l83_i3420_w1 = x[(64)*i+46] * y[(64)*i+46];
temp_l83_i3421_w1 = x[(64)*i+47] * y[(64)*i+47];
temp_l83_i3422_w1 = x[(64)*i+48] * y[(64)*i+48];
temp_l83_i3423_w1 = x[(64)*i+49] * y[(64)*i+49];
temp_l83_i3424_w1 = x[(64)*i+50] * y[(64)*i+50];
temp_l83_i3425_w1 = x[(64)*i+51] * y[(64)*i+51];
temp_l83_i3426_w1 = x[(64)*i+52] * y[(64)*i+52];
temp_l83_i3427_w1 = x[(64)*i+53] * y[(64)*i+53];
temp_l83_i3428_w1 = x[(64)*i+54] * y[(64)*i+54];
temp_l83_i3429_w1 = x[(64)*i+55] * y[(64)*i+55];
temp_l83_i3430_w1 = x[(64)*i+56] * y[(64)*i+56];
temp_l83_i3431_w1 = x[(64)*i+57] * y[(64)*i+57];
temp_l83_i3432_w1 = x[(64)*i+58] * y[(64)*i+58];
temp_l83_i3433_w1 = x[(64)*i+59] * y[(64)*i+59];
temp_l83_i3434_w1 = x[(64)*i+60] * y[(64)*i+60];
temp_l83_i3435_w1 = x[(64)*i+61] * y[(64)*i+61];
temp_l83_i3436_w1 = x[(64)*i+62] * y[(64)*i+62];
temp_l83_i3437_w1 = x[(64)*i+63] * y[(64)*i+63];

sum_w43 = temp_l83_i3374_w1 + temp_l83_i3375_w1;
sum_w44 = temp_l83_i3376_w1 + temp_l83_i3377_w1;
sum_w29 = temp_l83_i3378_w1 + temp_l83_i3379_w1;
sum_w30 = temp_l83_i3380_w1 + temp_l83_i3381_w1;
sum_w53 = temp_l83_i3382_w1 + temp_l83_i3383_w1;
sum_w54 = temp_l83_i3384_w1 + temp_l83_i3385_w1;
sum_w9 = temp_l83_i3386_w1 + temp_l83_i3387_w1;
sum_w10 = temp_l83_i3388_w1 + temp_l83_i3389_w1;
sum_w7 = temp_l83_i3390_w1 + temp_l83_i3391_w1;
sum_w8 = temp_l83_i3392_w1 + temp_l83_i3393_w1;
sum_w51 = temp_l83_i3394_w1 + temp_l83_i3395_w1;
sum_w52 = temp_l83_i3396_w1 + temp_l83_i3397_w1;
sum_w37 = temp_l83_i3398_w1 + temp_l83_i3399_w1;
sum_w38 = temp_l83_i3400_w1 + temp_l83_i3401_w1;
sum_w17 = temp_l83_i3402_w1 + temp_l83_i3403_w1;
sum_w18 = temp_l83_i3404_w1 + temp_l83_i3405_w1;
sum_w15 = temp_l83_i3406_w1 + temp_l83_i3407_w1;
sum_w16 = temp_l83_i3408_w1 + temp_l83_i3409_w1;
sum_w19 = temp_l83_i3410_w1 + temp_l83_i3411_w1;
sum_w20 = temp_l83_i3412_w1 + temp_l83_i3413_w1;
sum_w3 = temp_l83_i3414_w1 + temp_l83_i3415_w1;
sum_w4 = temp_l83_i3416_w1 + temp_l83_i3417_w1;
sum_w57 = temp_l83_i3418_w1 + temp_l83_i3419_w1;
sum_w58 = temp_l83_i3420_w1 + temp_l83_i3421_w1;
sum_w35 = temp_l83_i3422_w1 + temp_l83_i3423_w1;
sum_w36 = temp_l83_i3424_w1 + temp_l83_i3425_w1;
sum_w55 = temp_l83_i3426_w1 + temp_l83_i3427_w1;
sum_w56 = temp_l83_i3428_w1 + temp_l83_i3429_w1;
sum_w27 = temp_l83_i3430_w1 + temp_l83_i3431_w1;
sum_w28 = temp_l83_i3432_w1 + temp_l83_i3433_w1;
sum_w33 = temp_l83_i3434_w1 + temp_l83_i3435_w1;
sum_w34 = temp_l83_i3436_w1 + temp_l83_i3437_w1;

sum_w13 = sum_w15 + sum_w16;
sum_w32 = sum_w17 + sum_w18;
sum_w14 = sum_w19 + sum_w20;
sum_w47 = sum_w27 + sum_w28;
sum_w24 = sum_w29 + sum_w30;
sum_w49 = sum_w3 + sum_w4;
sum_w48 = sum_w33 + sum_w34;
sum_w25 = sum_w35 + sum_w36;
sum_w31 = sum_w37 + sum_w38;
sum_w23 = sum_w43 + sum_w44;
sum_w22 = sum_w51 + sum_w52;
sum_w41 = sum_w53 + sum_w54;
sum_w26 = sum_w55 + sum_w56;
sum_w50 = sum_w57 + sum_w58;
sum_w21 = sum_w7 + sum_w8;
sum_w42 = sum_w9 + sum_w10;

sum_w1 = sum_w13 + sum_w14;
sum_w61 = sum_w21 + sum_w22;
sum_w59 = sum_w23 + sum_w24;
sum_w11 = sum_w25 + sum_w26;
sum_w62 = sum_w31 + sum_w32;
sum_w60 = sum_w41 + sum_w42;
sum_w12 = sum_w47 + sum_w48;
sum_w2 = sum_w49 + sum_w50;

sum_w39 = sum_w1 + sum_w2;
sum_w40 = sum_w11 + sum_w12;
sum_w45 = sum_w59 + sum_w60;
sum_w46 = sum_w61 + sum_w62;

sum_w6 = sum_w39 + sum_w40;
sum_w5 = sum_w45 + sum_w46;
...
void epilogue(int sum_array_3[13], int sum_array_2[13], short y_6[51], int sum_array_4[9], short x_0[45], short y_0[45], short x_6[51], int sum_array_1[13], int sum_array_0[13], int *out) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w100;
...
sum_w106 = sum_array_0[12] + sum_array_1[0];
sum_w107 = sum_array_1[1] + sum_array_1[2];
sum_w80 = sum_array_1[3] + sum_array_1[4];
sum_w81 = sum_array_1[5] + sum_array_1[6];
sum_w43 = sum_array_1[7] + sum_array_1[8];
sum_w44 = sum_array_1[9] + sum_array_1[10];
sum_w15 = sum_array_1[11] + sum_array_1[12];
sum_w16 = sum_array_2[0] + sum_array_2[1];
sum_w82 = sum_array_2[2] + sum_array_2[3];
sum_w83 = sum_array_2[4] + sum_array_2[5];
sum_w41 = sum_array_2[6] + sum_array_2[7];
sum_w42 = sum_array_2[8] + sum_array_2[9];
sum_w31 = sum_array_2[10] + sum_array_2[11];
sum_w32 = sum_array_2[12] + sum_array_3[0];
sum_w115 = sum_array_3[1] + sum_array_3[2];
sum_w116 = sum_array_3[3] + sum_array_3[4];
sum_w113 = sum_array_3[5] + sum_array_3[6];
sum_w114 = sum_array_3[7] + sum_array_3[8];
sum_w125 = sum_array_3[9] + sum_array_3[10];
sum_w126 = sum_array_3[11] + sum_array_3[12];
sum_w104 = sum_array_4[0] + sum_array_4[1];
sum_w105 = sum_array_4[2] + sum_array_4[3];
sum_w29 = sum_array_4[4] + sum_array_4[5];
sum_w30 = sum_array_4[6] + sum_array_4[7];
...
temp_l83_i3950_w1 = x_6[0] * y_6[0];
temp_l83_i3951_w1 = x_6[1] * y_6[1];
temp_l83_i3952_w1 = x_6[2] * y_6[2];
temp_l83_i3953_w1 = x_6[3] * y_6[3];
temp_l83_i3954_w1 = x_6[4] * y_6[4];
temp_l83_i3955_w1 = x_6[5] * y_6[5];
temp_l83_i3956_w1 = x_6[6] * y_6[6];
temp_l83_i3957_w1 = x_6[7] * y_6[7];
temp_l83_i3958_w1 = x_6[8] * y_6[8];
temp_l83_i3959_w1 = x_6[9] * y_6[9];
temp_l83_i3960_w1 = x_6[10] * y_6[10];
temp_l83_i3961_w1 = x_6[11] * y_6[11];
temp_l83_i3962_w1 = x_6[12] * y_6[12];
temp_l83_i3963_w1 = x_6[13] * y_6[13];
temp_l83_i3964_w1 = x_6[14] * y_6[14];
temp_l83_i3965_w1 = x_6[15] * y_6[15];
temp_l83_i3966_w1 = x_6[16] * y_6[16];
temp_l83_i3967_w1 = x_6[17] * y_6[17];
temp_l83_i3968_w1 = x_6[18] * y_6[18];
temp_l83_i3969_w1 = x_6[19] * y_6[19];
temp_l83_i3970_w1 = x_6[20] * y_6[20];
temp_l83_i3971_w1 = x_6[21] * y_6[21];
temp_l83_i3972_w1 = x_6[22] * y_6[22];
temp_l83_i3973_w1 = x_6[23] * y_6[23];
temp_l83_i3974_w1 = x_6[24] * y_6[24];
temp_l83_i3975_w1 = x_6[25] * y_6[25];
temp_l83_i3976_w1 = x_6[26] * y_6[26];
temp_l83_i3977_w1 = x_6[27] * y_6[27];
temp_l83_i3978_w1 = x_6[28] * y_6[28];
temp_l83_i3979_w1 = x_6[29] * y_6[29];
temp_l83_i3980_w1 = x_6[30] * y_6[30];
temp_l83_i3981_w1 = x_6[31] * y_6[31];
temp_l83_i3982_w1 = x_6[32] * y_6[32];
temp_l83_i3983_w1 = x_6[33] * y_6[33];
temp_l83_i3984_w1 = x_6[34] * y_6[34];
temp_l83_i3985_w1 = x_6[35] * y_6[35];
temp_l83_i3986_w1 = x_6[36] * y_6[36];
temp_l83_i3987_w1 = x_6[37] * y_6[37];
temp_l83_i3988_w1 = x_6[38] * y_6[38];
temp_l83_i3989_w1 = x_6[39] * y_6[39];
temp_l83_i3990_w1 = x_6[40] * y_6[40];
temp_l83_i3991_w1 = x_6[41] * y_6[41];
temp_l83_i3992_w1 = x_6[42] * y_6[42];
temp_l83_i3993_w1 = x_6[43] * y_6[43];
temp_l83_i3994_w1 = x_6[44] * y_6[44];
temp_l83_i3995_w1 = x_6[45] * y_6[45];
temp_l83_i3996_w1 = x_6[46] * y_6[46];
temp_l83_i3997_w1 = x_6[47] * y_6[47];
temp_l83_i3998_w1 = x_6[48] * y_6[48];
temp_l83_i3999_w1 = x_6[49] * y_6[49];
temp_l83_i4000_w1 = x_6[50] * y_6[50];
...
void n4000_dotprod_parallel5(short x_0[45], short x_1[832], short x_2[832], short x_3[832], short x_4[832], short x_5[576], short x_6[51], short y_0[45], short y_1[832], short y_2[832], short y_3[832], short y_4[832], short y_5[576], short y_6[51], int *out) {
// Step 2: Initialize local variables
int sum_array_0[13];
int sum_array_1[13];
int sum_array_2[13];
...
#pragma HLS ARRAY_PARTITION variable=x_6 cyclic factor=51 dim=0
...
#pragma HLS ARRAY_PARTITION variable=y_6 cyclic factor=51 dim=0
...
epilogue(sum_array_3,sum_array_2,y_6,sum_array_4,x_0,y_0,x_6,sum_array_1,sum_array_0,out);
