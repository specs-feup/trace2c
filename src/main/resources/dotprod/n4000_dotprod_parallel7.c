...
void parallel_0(short x[576], short y[576], int sum_array[9]) {
...
void parallel_1(short x[448], short y[448], int sum_array[7]) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w11;
...
int sum_w8;
int sum_w9;
int temp_l83_i3502_w1;
int temp_l83_i3503_w1;
int temp_l83_i3504_w1;
int temp_l83_i3505_w1;
int temp_l83_i3506_w1;
int temp_l83_i3507_w1;
int temp_l83_i3508_w1;
int temp_l83_i3509_w1;
int temp_l83_i3510_w1;
int temp_l83_i3511_w1;
int temp_l83_i3512_w1;
int temp_l83_i3513_w1;
int temp_l83_i3514_w1;
int temp_l83_i3515_w1;
int temp_l83_i3516_w1;
int temp_l83_i3517_w1;
int temp_l83_i3518_w1;
int temp_l83_i3519_w1;
int temp_l83_i3520_w1;
int temp_l83_i3521_w1;
int temp_l83_i3522_w1;
int temp_l83_i3523_w1;
int temp_l83_i3524_w1;
int temp_l83_i3525_w1;
int temp_l83_i3526_w1;
int temp_l83_i3527_w1;
int temp_l83_i3528_w1;
int temp_l83_i3529_w1;
int temp_l83_i3530_w1;
int temp_l83_i3531_w1;
int temp_l83_i3532_w1;
int temp_l83_i3533_w1;
int temp_l83_i3534_w1;
int temp_l83_i3535_w1;
int temp_l83_i3536_w1;
int temp_l83_i3537_w1;
int temp_l83_i3538_w1;
int temp_l83_i3539_w1;
int temp_l83_i3540_w1;
int temp_l83_i3541_w1;
int temp_l83_i3542_w1;
int temp_l83_i3543_w1;
int temp_l83_i3544_w1;
int temp_l83_i3545_w1;
int temp_l83_i3546_w1;
int temp_l83_i3547_w1;
int temp_l83_i3548_w1;
int temp_l83_i3549_w1;
int temp_l83_i3550_w1;
int temp_l83_i3551_w1;
int temp_l83_i3552_w1;
int temp_l83_i3553_w1;
int temp_l83_i3554_w1;
int temp_l83_i3555_w1;
int temp_l83_i3556_w1;
int temp_l83_i3557_w1;
int temp_l83_i3558_w1;
int temp_l83_i3559_w1;
int temp_l83_i3560_w1;
int temp_l83_i3561_w1;
int temp_l83_i3562_w1;
int temp_l83_i3563_w1;
int temp_l83_i3564_w1;
int temp_l83_i3565_w1;
// Initialization done
// starting Loop
...
temp_l83_i3502_w1 = x[(64)*i] * y[(64)*i];
temp_l83_i3503_w1 = x[(64)*i+1] * y[(64)*i+1];
temp_l83_i3504_w1 = x[(64)*i+2] * y[(64)*i+2];
temp_l83_i3505_w1 = x[(64)*i+3] * y[(64)*i+3];
temp_l83_i3506_w1 = x[(64)*i+4] * y[(64)*i+4];
temp_l83_i3507_w1 = x[(64)*i+5] * y[(64)*i+5];
temp_l83_i3508_w1 = x[(64)*i+6] * y[(64)*i+6];
temp_l83_i3509_w1 = x[(64)*i+7] * y[(64)*i+7];
temp_l83_i3510_w1 = x[(64)*i+8] * y[(64)*i+8];
temp_l83_i3511_w1 = x[(64)*i+9] * y[(64)*i+9];
temp_l83_i3512_w1 = x[(64)*i+10] * y[(64)*i+10];
temp_l83_i3513_w1 = x[(64)*i+11] * y[(64)*i+11];
temp_l83_i3514_w1 = x[(64)*i+12] * y[(64)*i+12];
temp_l83_i3515_w1 = x[(64)*i+13] * y[(64)*i+13];
temp_l83_i3516_w1 = x[(64)*i+14] * y[(64)*i+14];
temp_l83_i3517_w1 = x[(64)*i+15] * y[(64)*i+15];
temp_l83_i3518_w1 = x[(64)*i+16] * y[(64)*i+16];
temp_l83_i3519_w1 = x[(64)*i+17] * y[(64)*i+17];
temp_l83_i3520_w1 = x[(64)*i+18] * y[(64)*i+18];
temp_l83_i3521_w1 = x[(64)*i+19] * y[(64)*i+19];
temp_l83_i3522_w1 = x[(64)*i+20] * y[(64)*i+20];
temp_l83_i3523_w1 = x[(64)*i+21] * y[(64)*i+21];
temp_l83_i3524_w1 = x[(64)*i+22] * y[(64)*i+22];
temp_l83_i3525_w1 = x[(64)*i+23] * y[(64)*i+23];
temp_l83_i3526_w1 = x[(64)*i+24] * y[(64)*i+24];
temp_l83_i3527_w1 = x[(64)*i+25] * y[(64)*i+25];
temp_l83_i3528_w1 = x[(64)*i+26] * y[(64)*i+26];
temp_l83_i3529_w1 = x[(64)*i+27] * y[(64)*i+27];
temp_l83_i3530_w1 = x[(64)*i+28] * y[(64)*i+28];
temp_l83_i3531_w1 = x[(64)*i+29] * y[(64)*i+29];
temp_l83_i3532_w1 = x[(64)*i+30] * y[(64)*i+30];
temp_l83_i3533_w1 = x[(64)*i+31] * y[(64)*i+31];
temp_l83_i3534_w1 = x[(64)*i+32] * y[(64)*i+32];
temp_l83_i3535_w1 = x[(64)*i+33] * y[(64)*i+33];
temp_l83_i3536_w1 = x[(64)*i+34] * y[(64)*i+34];
temp_l83_i3537_w1 = x[(64)*i+35] * y[(64)*i+35];
temp_l83_i3538_w1 = x[(64)*i+36] * y[(64)*i+36];
temp_l83_i3539_w1 = x[(64)*i+37] * y[(64)*i+37];
temp_l83_i3540_w1 = x[(64)*i+38] * y[(64)*i+38];
temp_l83_i3541_w1 = x[(64)*i+39] * y[(64)*i+39];
temp_l83_i3542_w1 = x[(64)*i+40] * y[(64)*i+40];
temp_l83_i3543_w1 = x[(64)*i+41] * y[(64)*i+41];
temp_l83_i3544_w1 = x[(64)*i+42] * y[(64)*i+42];
temp_l83_i3545_w1 = x[(64)*i+43] * y[(64)*i+43];
temp_l83_i3546_w1 = x[(64)*i+44] * y[(64)*i+44];
temp_l83_i3547_w1 = x[(64)*i+45] * y[(64)*i+45];
temp_l83_i3548_w1 = x[(64)*i+46] * y[(64)*i+46];
temp_l83_i3549_w1 = x[(64)*i+47] * y[(64)*i+47];
temp_l83_i3550_w1 = x[(64)*i+48] * y[(64)*i+48];
temp_l83_i3551_w1 = x[(64)*i+49] * y[(64)*i+49];
temp_l83_i3552_w1 = x[(64)*i+50] * y[(64)*i+50];
temp_l83_i3553_w1 = x[(64)*i+51] * y[(64)*i+51];
temp_l83_i3554_w1 = x[(64)*i+52] * y[(64)*i+52];
temp_l83_i3555_w1 = x[(64)*i+53] * y[(64)*i+53];
temp_l83_i3556_w1 = x[(64)*i+54] * y[(64)*i+54];
temp_l83_i3557_w1 = x[(64)*i+55] * y[(64)*i+55];
temp_l83_i3558_w1 = x[(64)*i+56] * y[(64)*i+56];
temp_l83_i3559_w1 = x[(64)*i+57] * y[(64)*i+57];
temp_l83_i3560_w1 = x[(64)*i+58] * y[(64)*i+58];
temp_l83_i3561_w1 = x[(64)*i+59] * y[(64)*i+59];
temp_l83_i3562_w1 = x[(64)*i+60] * y[(64)*i+60];
temp_l83_i3563_w1 = x[(64)*i+61] * y[(64)*i+61];
temp_l83_i3564_w1 = x[(64)*i+62] * y[(64)*i+62];
temp_l83_i3565_w1 = x[(64)*i+63] * y[(64)*i+63];

sum_w47 = temp_l83_i3502_w1 + temp_l83_i3503_w1;
sum_w48 = temp_l83_i3504_w1 + temp_l83_i3505_w1;
sum_w27 = temp_l83_i3506_w1 + temp_l83_i3507_w1;
sum_w28 = temp_l83_i3508_w1 + temp_l83_i3509_w1;
sum_w55 = temp_l83_i3510_w1 + temp_l83_i3511_w1;
sum_w56 = temp_l83_i3512_w1 + temp_l83_i3513_w1;
sum_w17 = temp_l83_i3514_w1 + temp_l83_i3515_w1;
sum_w18 = temp_l83_i3516_w1 + temp_l83_i3517_w1;
sum_w33 = temp_l83_i3518_w1 + temp_l83_i3519_w1;
sum_w34 = temp_l83_i3520_w1 + temp_l83_i3521_w1;
sum_w23 = temp_l83_i3522_w1 + temp_l83_i3523_w1;
sum_w24 = temp_l83_i3524_w1 + temp_l83_i3525_w1;
sum_w57 = temp_l83_i3526_w1 + temp_l83_i3527_w1;
sum_w58 = temp_l83_i3528_w1 + temp_l83_i3529_w1;
sum_w31 = temp_l83_i3530_w1 + temp_l83_i3531_w1;
sum_w32 = temp_l83_i3532_w1 + temp_l83_i3533_w1;
sum_w51 = temp_l83_i3534_w1 + temp_l83_i3535_w1;
sum_w52 = temp_l83_i3536_w1 + temp_l83_i3537_w1;
sum_w21 = temp_l83_i3538_w1 + temp_l83_i3539_w1;
sum_w22 = temp_l83_i3540_w1 + temp_l83_i3541_w1;
sum_w3 = temp_l83_i3542_w1 + temp_l83_i3543_w1;
sum_w4 = temp_l83_i3544_w1 + temp_l83_i3545_w1;
sum_w29 = temp_l83_i3546_w1 + temp_l83_i3547_w1;
sum_w30 = temp_l83_i3548_w1 + temp_l83_i3549_w1;
sum_w43 = temp_l83_i3550_w1 + temp_l83_i3551_w1;
sum_w44 = temp_l83_i3552_w1 + temp_l83_i3553_w1;
sum_w13 = temp_l83_i3554_w1 + temp_l83_i3555_w1;
sum_w14 = temp_l83_i3556_w1 + temp_l83_i3557_w1;
sum_w37 = temp_l83_i3558_w1 + temp_l83_i3559_w1;
sum_w38 = temp_l83_i3560_w1 + temp_l83_i3561_w1;
sum_w41 = temp_l83_i3562_w1 + temp_l83_i3563_w1;
sum_w42 = temp_l83_i3564_w1 + temp_l83_i3565_w1;

sum_w60 = sum_w13 + sum_w14;
sum_w36 = sum_w17 + sum_w18;
sum_w40 = sum_w21 + sum_w22;
sum_w26 = sum_w23 + sum_w24;
sum_w50 = sum_w27 + sum_w28;
sum_w10 = sum_w29 + sum_w30;
sum_w9 = sum_w3 + sum_w4;
sum_w12 = sum_w31 + sum_w32;
sum_w25 = sum_w33 + sum_w34;
sum_w7 = sum_w37 + sum_w38;
sum_w8 = sum_w41 + sum_w42;
sum_w59 = sum_w43 + sum_w44;
sum_w49 = sum_w47 + sum_w48;
sum_w39 = sum_w51 + sum_w52;
sum_w35 = sum_w55 + sum_w56;
sum_w11 = sum_w57 + sum_w58;

sum_w62 = sum_w11 + sum_w12;
sum_w61 = sum_w25 + sum_w26;
sum_w16 = sum_w35 + sum_w36;
sum_w1 = sum_w39 + sum_w40;
sum_w15 = sum_w49 + sum_w50;
sum_w45 = sum_w59 + sum_w60;
sum_w46 = sum_w7 + sum_w8;
sum_w2 = sum_w9 + sum_w10;

sum_w19 = sum_w1 + sum_w2;
sum_w5 = sum_w15 + sum_w16;
sum_w20 = sum_w45 + sum_w46;
sum_w6 = sum_w61 + sum_w62;

sum_w54 = sum_w19 + sum_w20;
sum_w53 = sum_w5 + sum_w6;
...
void epilogue(short x_8[51], int sum_array_3[9], int sum_array_2[9], int sum_array_5[9], int sum_array_4[9], short y_8[51], int sum_array_6[7], short x_0[45], short y_0[45], int sum_array_1[9], int sum_array_0[9], int *out) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w100;
...
sum_w35 = sum_array_0[8] + sum_array_1[0];
sum_w36 = sum_array_1[1] + sum_array_1[2];
sum_w106 = sum_array_1[3] + sum_array_1[4];
sum_w107 = sum_array_1[5] + sum_array_1[6];
sum_w80 = sum_array_1[7] + sum_array_1[8];
sum_w81 = sum_array_2[0] + sum_array_2[1];
sum_w43 = sum_array_2[2] + sum_array_2[3];
sum_w44 = sum_array_2[4] + sum_array_2[5];
sum_w15 = sum_array_2[6] + sum_array_2[7];
sum_w16 = sum_array_2[8] + sum_array_3[0];
sum_w82 = sum_array_3[1] + sum_array_3[2];
sum_w83 = sum_array_3[3] + sum_array_3[4];
sum_w41 = sum_array_3[5] + sum_array_3[6];
sum_w42 = sum_array_3[7] + sum_array_3[8];
sum_w31 = sum_array_4[0] + sum_array_4[1];
sum_w32 = sum_array_4[2] + sum_array_4[3];
sum_w115 = sum_array_4[4] + sum_array_4[5];
sum_w116 = sum_array_4[6] + sum_array_4[7];
sum_w113 = sum_array_4[8] + sum_array_5[0];
sum_w114 = sum_array_5[1] + sum_array_5[2];
sum_w125 = sum_array_5[3] + sum_array_5[4];
sum_w126 = sum_array_5[5] + sum_array_5[6];
sum_w104 = sum_array_5[7] + sum_array_5[8];
sum_w105 = sum_array_6[0] + sum_array_6[1];
sum_w29 = sum_array_6[2] + sum_array_6[3];
sum_w30 = sum_array_6[4] + sum_array_6[5];
...
temp_l83_i3950_w1 = x_8[0] * y_8[0];
temp_l83_i3951_w1 = x_8[1] * y_8[1];
temp_l83_i3952_w1 = x_8[2] * y_8[2];
temp_l83_i3953_w1 = x_8[3] * y_8[3];
temp_l83_i3954_w1 = x_8[4] * y_8[4];
temp_l83_i3955_w1 = x_8[5] * y_8[5];
temp_l83_i3956_w1 = x_8[6] * y_8[6];
temp_l83_i3957_w1 = x_8[7] * y_8[7];
temp_l83_i3958_w1 = x_8[8] * y_8[8];
temp_l83_i3959_w1 = x_8[9] * y_8[9];
temp_l83_i3960_w1 = x_8[10] * y_8[10];
temp_l83_i3961_w1 = x_8[11] * y_8[11];
temp_l83_i3962_w1 = x_8[12] * y_8[12];
temp_l83_i3963_w1 = x_8[13] * y_8[13];
temp_l83_i3964_w1 = x_8[14] * y_8[14];
temp_l83_i3965_w1 = x_8[15] * y_8[15];
temp_l83_i3966_w1 = x_8[16] * y_8[16];
temp_l83_i3967_w1 = x_8[17] * y_8[17];
temp_l83_i3968_w1 = x_8[18] * y_8[18];
temp_l83_i3969_w1 = x_8[19] * y_8[19];
temp_l83_i3970_w1 = x_8[20] * y_8[20];
temp_l83_i3971_w1 = x_8[21] * y_8[21];
temp_l83_i3972_w1 = x_8[22] * y_8[22];
temp_l83_i3973_w1 = x_8[23] * y_8[23];
temp_l83_i3974_w1 = x_8[24] * y_8[24];
temp_l83_i3975_w1 = x_8[25] * y_8[25];
temp_l83_i3976_w1 = x_8[26] * y_8[26];
temp_l83_i3977_w1 = x_8[27] * y_8[27];
temp_l83_i3978_w1 = x_8[28] * y_8[28];
temp_l83_i3979_w1 = x_8[29] * y_8[29];
temp_l83_i3980_w1 = x_8[30] * y_8[30];
temp_l83_i3981_w1 = x_8[31] * y_8[31];
temp_l83_i3982_w1 = x_8[32] * y_8[32];
temp_l83_i3983_w1 = x_8[33] * y_8[33];
temp_l83_i3984_w1 = x_8[34] * y_8[34];
temp_l83_i3985_w1 = x_8[35] * y_8[35];
temp_l83_i3986_w1 = x_8[36] * y_8[36];
temp_l83_i3987_w1 = x_8[37] * y_8[37];
temp_l83_i3988_w1 = x_8[38] * y_8[38];
temp_l83_i3989_w1 = x_8[39] * y_8[39];
temp_l83_i3990_w1 = x_8[40] * y_8[40];
temp_l83_i3991_w1 = x_8[41] * y_8[41];
temp_l83_i3992_w1 = x_8[42] * y_8[42];
temp_l83_i3993_w1 = x_8[43] * y_8[43];
temp_l83_i3994_w1 = x_8[44] * y_8[44];
temp_l83_i3995_w1 = x_8[45] * y_8[45];
temp_l83_i3996_w1 = x_8[46] * y_8[46];
temp_l83_i3997_w1 = x_8[47] * y_8[47];
temp_l83_i3998_w1 = x_8[48] * y_8[48];
temp_l83_i3999_w1 = x_8[49] * y_8[49];
temp_l83_i4000_w1 = x_8[50] * y_8[50];
...
void n4000_dotprod_parallel7(short x_0[45], short x_1[576], short x_2[576], short x_3[576], short x_4[576], short x_5[576], short x_6[576], short x_7[448], short x_8[51], short y_0[45], short y_1[576], short y_2[576], short y_3[576], short y_4[576], short y_5[576], short y_6[576], short y_7[448], short y_8[51], int *out) {
// Step 2: Initialize local variables
int sum_array_0[9];
int sum_array_1[9];
int sum_array_2[9];
...
#pragma HLS ARRAY_PARTITION variable=x_8 cyclic factor=51 dim=0
...
#pragma HLS ARRAY_PARTITION variable=y_8 cyclic factor=51 dim=0
...
epilogue(x_8,sum_array_3,sum_array_2,sum_array_5,sum_array_4,y_8,sum_array_6,x_0,y_0,sum_array_1,sum_array_0,out);
