...
void parallel_0(short x[288], short y[288], int sum_array[18]) {
...
void parallel_1(short x[256], short y[256], int sum_array[16]) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w11;
...
int sum_w8;
int sum_w9;
int temp_l83_i1742_w1;
int temp_l83_i1743_w1;
int temp_l83_i1744_w1;
int temp_l83_i1745_w1;
int temp_l83_i1746_w1;
int temp_l83_i1747_w1;
int temp_l83_i1748_w1;
int temp_l83_i1749_w1;
int temp_l83_i1750_w1;
int temp_l83_i1751_w1;
int temp_l83_i1752_w1;
int temp_l83_i1753_w1;
int temp_l83_i1754_w1;
int temp_l83_i1755_w1;
int temp_l83_i1756_w1;
int temp_l83_i1757_w1;
// Initialization done
// starting Loop
...
temp_l83_i1742_w1 = x[(16)*i] * y[(16)*i];
temp_l83_i1743_w1 = x[(16)*i+1] * y[(16)*i+1];
temp_l83_i1744_w1 = x[(16)*i+2] * y[(16)*i+2];
temp_l83_i1745_w1 = x[(16)*i+3] * y[(16)*i+3];
temp_l83_i1746_w1 = x[(16)*i+4] * y[(16)*i+4];
temp_l83_i1747_w1 = x[(16)*i+5] * y[(16)*i+5];
temp_l83_i1748_w1 = x[(16)*i+6] * y[(16)*i+6];
temp_l83_i1749_w1 = x[(16)*i+7] * y[(16)*i+7];
temp_l83_i1750_w1 = x[(16)*i+8] * y[(16)*i+8];
temp_l83_i1751_w1 = x[(16)*i+9] * y[(16)*i+9];
temp_l83_i1752_w1 = x[(16)*i+10] * y[(16)*i+10];
temp_l83_i1753_w1 = x[(16)*i+11] * y[(16)*i+11];
temp_l83_i1754_w1 = x[(16)*i+12] * y[(16)*i+12];
temp_l83_i1755_w1 = x[(16)*i+13] * y[(16)*i+13];
temp_l83_i1756_w1 = x[(16)*i+14] * y[(16)*i+14];
temp_l83_i1757_w1 = x[(16)*i+15] * y[(16)*i+15];

sum_w13 = temp_l83_i1742_w1 + temp_l83_i1743_w1;
sum_w14 = temp_l83_i1744_w1 + temp_l83_i1745_w1;
sum_w9 = temp_l83_i1746_w1 + temp_l83_i1747_w1;
sum_w10 = temp_l83_i1748_w1 + temp_l83_i1749_w1;
sum_w7 = temp_l83_i1750_w1 + temp_l83_i1751_w1;
sum_w8 = temp_l83_i1752_w1 + temp_l83_i1753_w1;
sum_w3 = temp_l83_i1754_w1 + temp_l83_i1755_w1;
sum_w4 = temp_l83_i1756_w1 + temp_l83_i1757_w1;

sum_w11 = sum_w13 + sum_w14;
sum_w6 = sum_w3 + sum_w4;
sum_w5 = sum_w7 + sum_w8;
sum_w12 = sum_w9 + sum_w10;
...
void epilogue(short x_8[3], int sum_array_3[18], int sum_array_2[18], int sum_array_5[18], short y_8[3], int sum_array_4[18], int sum_array_6[16], short x_0[13], short y_0[13], int sum_array_1[18], int sum_array_0[18], int *out) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w100;
...
sum_w21 = sum_array_1[0] + sum_array_1[1];
sum_w22 = sum_array_1[2] + sum_array_1[3];
sum_w29 = sum_array_1[4] + sum_array_1[5];
sum_w30 = sum_array_1[6] + sum_array_1[7];
sum_w92 = sum_array_1[8] + sum_array_1[9];
sum_w93 = sum_array_1[10] + sum_array_1[11];
sum_w37 = sum_array_1[12] + sum_array_1[13];
sum_w38 = sum_array_1[14] + sum_array_1[15];
sum_w3 = sum_array_1[16] + sum_array_1[17];
sum_w4 = sum_array_2[0] + sum_array_2[1];
sum_w118 = sum_array_2[2] + sum_array_2[3];
sum_w119 = sum_array_2[4] + sum_array_2[5];
sum_w132 = sum_array_2[6] + sum_array_2[7];
sum_w133 = sum_array_2[8] + sum_array_2[9];
sum_w106 = sum_array_2[10] + sum_array_2[11];
sum_w107 = sum_array_2[12] + sum_array_2[13];
sum_w82 = sum_array_2[14] + sum_array_2[15];
sum_w83 = sum_array_2[16] + sum_array_2[17];
sum_w100 = sum_array_3[0] + sum_array_3[1];
sum_w101 = sum_array_3[2] + sum_array_3[3];
sum_w27 = sum_array_3[4] + sum_array_3[5];
sum_w28 = sum_array_3[6] + sum_array_3[7];
sum_w84 = sum_array_3[8] + sum_array_3[9];
sum_w85 = sum_array_3[10] + sum_array_3[11];
sum_w41 = sum_array_3[12] + sum_array_3[13];
sum_w42 = sum_array_3[14] + sum_array_3[15];
sum_w39 = sum_array_3[16] + sum_array_3[17];
sum_w40 = sum_array_4[0] + sum_array_4[1];
sum_w35 = sum_array_4[2] + sum_array_4[3];
sum_w36 = sum_array_4[4] + sum_array_4[5];
sum_w49 = sum_array_4[6] + sum_array_4[7];
sum_w50 = sum_array_4[8] + sum_array_4[9];
sum_w112 = sum_array_4[10] + sum_array_4[11];
sum_w113 = sum_array_4[12] + sum_array_4[13];
sum_w63 = sum_array_4[14] + sum_array_4[15];
sum_w64 = sum_array_4[16] + sum_array_4[17];
sum_w55 = sum_array_5[0] + sum_array_5[1];
sum_w56 = sum_array_5[2] + sum_array_5[3];
sum_w77 = sum_array_5[4] + sum_array_5[5];
sum_w78 = sum_array_5[6] + sum_array_5[7];
sum_w53 = sum_array_5[8] + sum_array_5[9];
sum_w54 = sum_array_5[10] + sum_array_5[11];
sum_w88 = sum_array_5[12] + sum_array_5[13];
sum_w89 = sum_array_5[14] + sum_array_5[15];
sum_w5 = sum_array_5[16] + sum_array_5[17];
sum_w6 = sum_array_6[0] + sum_array_6[1];
sum_w17 = sum_array_6[2] + sum_array_6[3];
sum_w18 = sum_array_6[4] + sum_array_6[5];
sum_w13 = sum_array_6[6] + sum_array_6[7];
sum_w14 = sum_array_6[8] + sum_array_6[9];
sum_w45 = sum_array_6[10] + sum_array_6[11];
sum_w46 = sum_array_6[12] + sum_array_6[13];
sum_w16 = sum_array_6[14] + sum_array_6[15];
...
temp_l83_i1998_w1 = x_8[0] * y_8[0];
temp_l83_i1999_w1 = x_8[1] * y_8[1];
temp_l83_i2000_w1 = x_8[2] * y_8[2];
...
void dotprod_parallel7(short x_0[13], short x_1[288], short x_2[288], short x_3[288], short x_4[288], short x_5[288], short x_6[288], short x_7[256], short x_8[3], short y_0[13], short y_1[288], short y_2[288], short y_3[288], short y_4[288], short y_5[288], short y_6[288], short y_7[256], short y_8[3], int *out) {
// Step 2: Initialize local variables
int sum_array_0[18];
int sum_array_1[18];
int sum_array_2[18];
...
epilogue(x_8,sum_array_3,sum_array_2,sum_array_5,y_8,sum_array_4,sum_array_6,x_0,y_0,sum_array_1,sum_array_0,out);
