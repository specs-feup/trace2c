...
void parallel_0(short x[576], short y[576], int sum_array[36]) {
...
void parallel_1(short x[528], short y[528], int sum_array[33]) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w11;
...
int sum_w8;
int sum_w9;
int temp_l83_i3470_w1;
int temp_l83_i3471_w1;
int temp_l83_i3472_w1;
int temp_l83_i3473_w1;
int temp_l83_i3474_w1;
int temp_l83_i3475_w1;
int temp_l83_i3476_w1;
int temp_l83_i3477_w1;
int temp_l83_i3478_w1;
int temp_l83_i3479_w1;
int temp_l83_i3480_w1;
int temp_l83_i3481_w1;
int temp_l83_i3482_w1;
int temp_l83_i3483_w1;
int temp_l83_i3484_w1;
int temp_l83_i3485_w1;
// Initialization done
// starting Loop
...
temp_l83_i3470_w1 = x[(16)*i] * y[(16)*i];
temp_l83_i3471_w1 = x[(16)*i+1] * y[(16)*i+1];
temp_l83_i3472_w1 = x[(16)*i+2] * y[(16)*i+2];
temp_l83_i3473_w1 = x[(16)*i+3] * y[(16)*i+3];
temp_l83_i3474_w1 = x[(16)*i+4] * y[(16)*i+4];
temp_l83_i3475_w1 = x[(16)*i+5] * y[(16)*i+5];
temp_l83_i3476_w1 = x[(16)*i+6] * y[(16)*i+6];
temp_l83_i3477_w1 = x[(16)*i+7] * y[(16)*i+7];
temp_l83_i3478_w1 = x[(16)*i+8] * y[(16)*i+8];
temp_l83_i3479_w1 = x[(16)*i+9] * y[(16)*i+9];
temp_l83_i3480_w1 = x[(16)*i+10] * y[(16)*i+10];
temp_l83_i3481_w1 = x[(16)*i+11] * y[(16)*i+11];
temp_l83_i3482_w1 = x[(16)*i+12] * y[(16)*i+12];
temp_l83_i3483_w1 = x[(16)*i+13] * y[(16)*i+13];
temp_l83_i3484_w1 = x[(16)*i+14] * y[(16)*i+14];
temp_l83_i3485_w1 = x[(16)*i+15] * y[(16)*i+15];

sum_w13 = temp_l83_i3470_w1 + temp_l83_i3471_w1;
sum_w14 = temp_l83_i3472_w1 + temp_l83_i3473_w1;
sum_w3 = temp_l83_i3474_w1 + temp_l83_i3475_w1;
sum_w4 = temp_l83_i3476_w1 + temp_l83_i3477_w1;
sum_w7 = temp_l83_i3478_w1 + temp_l83_i3479_w1;
sum_w8 = temp_l83_i3480_w1 + temp_l83_i3481_w1;
sum_w5 = temp_l83_i3482_w1 + temp_l83_i3483_w1;
sum_w6 = temp_l83_i3484_w1 + temp_l83_i3485_w1;

sum_w9 = sum_w13 + sum_w14;
sum_w10 = sum_w3 + sum_w4;
sum_w2 = sum_w5 + sum_w6;
sum_w1 = sum_w7 + sum_w8;

sum_w12 = sum_w1 + sum_w2;
sum_w11 = sum_w9 + sum_w10;

sum_array[i] = sum_w11 + sum_w12;

}
}

void epilogue(int sum_array_3[36], short x_8[3], int sum_array_2[36], int sum_array_5[36], int sum_array_4[36], short y_8[3], int sum_array_6[33], short x_0[13], short y_0[13], int sum_array_1[36], int sum_array_0[36], int *out) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w100;
...
sum_w4 = sum_array_1[0] + sum_array_1[1];
sum_w243 = sum_array_1[2] + sum_array_1[3];
sum_w244 = sum_array_1[4] + sum_array_1[5];
sum_w257 = sum_array_1[6] + sum_array_1[7];
sum_w258 = sum_array_1[8] + sum_array_1[9];
sum_w71 = sum_array_1[10] + sum_array_1[11];
sum_w72 = sum_array_1[12] + sum_array_1[13];
sum_w208 = sum_array_1[14] + sum_array_1[15];
sum_w209 = sum_array_1[16] + sum_array_1[17];
sum_w61 = sum_array_1[18] + sum_array_1[19];
sum_w62 = sum_array_1[20] + sum_array_1[21];
sum_w141 = sum_array_1[22] + sum_array_1[23];
sum_w142 = sum_array_1[24] + sum_array_1[25];
sum_w210 = sum_array_1[26] + sum_array_1[27];
sum_w211 = sum_array_1[28] + sum_array_1[29];
sum_w155 = sum_array_1[30] + sum_array_1[31];
sum_w156 = sum_array_1[32] + sum_array_1[33];
sum_w29 = sum_array_1[34] + sum_array_1[35];
sum_w30 = sum_array_2[0] + sum_array_2[1];
sum_w149 = sum_array_2[2] + sum_array_2[3];
sum_w150 = sum_array_2[4] + sum_array_2[5];
sum_w163 = sum_array_2[6] + sum_array_2[7];
sum_w164 = sum_array_2[8] + sum_array_2[9];
sum_w83 = sum_array_2[10] + sum_array_2[11];
sum_w84 = sum_array_2[12] + sum_array_2[13];
sum_w47 = sum_array_2[14] + sum_array_2[15];
sum_w48 = sum_array_2[16] + sum_array_2[17];
sum_w173 = sum_array_2[18] + sum_array_2[19];
sum_w174 = sum_array_2[20] + sum_array_2[21];
sum_w199 = sum_array_2[22] + sum_array_2[23];
sum_w200 = sum_array_2[24] + sum_array_2[25];
sum_w171 = sum_array_2[26] + sum_array_2[27];
sum_w172 = sum_array_2[28] + sum_array_2[29];
sum_w214 = sum_array_2[30] + sum_array_2[31];
sum_w215 = sum_array_2[32] + sum_array_2[33];
sum_w5 = sum_array_2[34] + sum_array_2[35];
sum_w6 = sum_array_3[0] + sum_array_3[1];
sum_w129 = sum_array_3[2] + sum_array_3[3];
sum_w130 = sum_array_3[4] + sum_array_3[5];
sum_w127 = sum_array_3[6] + sum_array_3[7];
sum_w128 = sum_array_3[8] + sum_array_3[9];
sum_w157 = sum_array_3[10] + sum_array_3[11];
sum_w158 = sum_array_3[12] + sum_array_3[13];
sum_w131 = sum_array_3[14] + sum_array_3[15];
sum_w132 = sum_array_3[16] + sum_array_3[17];
sum_w101 = sum_array_3[18] + sum_array_3[19];
sum_w102 = sum_array_3[20] + sum_array_3[21];
sum_w17 = sum_array_3[22] + sum_array_3[23];
sum_w18 = sum_array_3[24] + sum_array_3[25];
sum_w201 = sum_array_3[26] + sum_array_3[27];
sum_w202 = sum_array_3[28] + sum_array_3[29];
sum_w145 = sum_array_3[30] + sum_array_3[31];
sum_w146 = sum_array_3[32] + sum_array_3[33];
sum_w203 = sum_array_3[34] + sum_array_3[35];
sum_w204 = sum_array_4[0] + sum_array_4[1];
sum_w35 = sum_array_4[2] + sum_array_4[3];
sum_w36 = sum_array_4[4] + sum_array_4[5];
sum_w261 = sum_array_4[6] + sum_array_4[7];
sum_w262 = sum_array_4[8] + sum_array_4[9];
sum_w239 = sum_array_4[10] + sum_array_4[11];
sum_w240 = sum_array_4[12] + sum_array_4[13];
sum_w189 = sum_array_4[14] + sum_array_4[15];
sum_w190 = sum_array_4[16] + sum_array_4[17];
sum_w218 = sum_array_4[18] + sum_array_4[19];
sum_w219 = sum_array_4[20] + sum_array_4[21];
sum_w67 = sum_array_4[22] + sum_array_4[23];
sum_w68 = sum_array_4[24] + sum_array_4[25];
sum_w259 = sum_array_4[26] + sum_array_4[27];
sum_w260 = sum_array_4[28] + sum_array_4[29];
sum_w85 = sum_array_4[30] + sum_array_4[31];
sum_w86 = sum_array_4[32] + sum_array_4[33];
sum_w167 = sum_array_4[34] + sum_array_4[35];
sum_w168 = sum_array_5[0] + sum_array_5[1];
sum_w87 = sum_array_5[2] + sum_array_5[3];
sum_w88 = sum_array_5[4] + sum_array_5[5];
sum_w237 = sum_array_5[6] + sum_array_5[7];
sum_w238 = sum_array_5[8] + sum_array_5[9];
sum_w117 = sum_array_5[10] + sum_array_5[11];
sum_w118 = sum_array_5[12] + sum_array_5[13];
sum_w81 = sum_array_5[14] + sum_array_5[15];
sum_w82 = sum_array_5[16] + sum_array_5[17];
sum_w109 = sum_array_5[18] + sum_array_5[19];
sum_w110 = sum_array_5[20] + sum_array_5[21];
sum_w75 = sum_array_5[22] + sum_array_5[23];
sum_w76 = sum_array_5[24] + sum_array_5[25];
sum_w11 = sum_array_5[26] + sum_array_5[27];
sum_w12 = sum_array_5[28] + sum_array_5[29];
sum_w137 = sum_array_5[30] + sum_array_5[31];
sum_w138 = sum_array_5[32] + sum_array_5[33];
sum_w37 = sum_array_5[34] + sum_array_5[35];
sum_w38 = sum_array_6[0] + sum_array_6[1];
sum_w253 = sum_array_6[2] + sum_array_6[3];
sum_w254 = sum_array_6[4] + sum_array_6[5];
sum_w183 = sum_array_6[6] + sum_array_6[7];
sum_w184 = sum_array_6[8] + sum_array_6[9];
sum_w89 = sum_array_6[10] + sum_array_6[11];
sum_w90 = sum_array_6[12] + sum_array_6[13];
sum_w73 = sum_array_6[14] + sum_array_6[15];
sum_w74 = sum_array_6[16] + sum_array_6[17];
sum_w39 = sum_array_6[18] + sum_array_6[19];
sum_w40 = sum_array_6[20] + sum_array_6[21];
sum_w161 = sum_array_6[22] + sum_array_6[23];
sum_w162 = sum_array_6[24] + sum_array_6[25];
sum_w165 = sum_array_6[26] + sum_array_6[27];
sum_w166 = sum_array_6[28] + sum_array_6[29];
sum_w241 = sum_array_6[30] + sum_array_6[31];
...
temp_l83_i3998_w1 = x_8[0] * y_8[0];
temp_l83_i3999_w1 = x_8[1] * y_8[1];
temp_l83_i4000_w1 = x_8[2] * y_8[2];
...
sum_w242 = sum_array_6[32] + sum_w232;
...
void n4000_maxNodes_100_dotprod_parallel7(short x_0[13], short x_1[576], short x_2[576], short x_3[576], short x_4[576], short x_5[576], short x_6[576], short x_7[528], short x_8[3], short y_0[13], short y_1[576], short y_2[576], short y_3[576], short y_4[576], short y_5[576], short y_6[576], short y_7[528], short y_8[3], int *out) {
// Step 2: Initialize local variables
int sum_array_0[36];
int sum_array_1[36];
int sum_array_2[36];
...
#pragma HLS ARRAY_PARTITION variable=x_8 cyclic factor=3 dim=0
...
#pragma HLS ARRAY_PARTITION variable=y_8 cyclic factor=3 dim=0
...
parallel_1(x_7,y_7,sum_array_6);


epilogue(sum_array_3,x_8,sum_array_2,sum_array_5,sum_array_4,y_8,sum_array_6,x_0,y_0,sum_array_1,sum_array_0,out);
