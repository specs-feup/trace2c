...
void parallel_0(short x[1024], short y[1024], int sum_array[16]) {
...
void parallel_1(short x[832], short y[832], int sum_array[13]) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w11;
...
int sum_w8;
int sum_w9;
int temp_l83_i3118_w1;
int temp_l83_i3119_w1;
int temp_l83_i3120_w1;
int temp_l83_i3121_w1;
int temp_l83_i3122_w1;
int temp_l83_i3123_w1;
int temp_l83_i3124_w1;
int temp_l83_i3125_w1;
int temp_l83_i3126_w1;
int temp_l83_i3127_w1;
int temp_l83_i3128_w1;
int temp_l83_i3129_w1;
int temp_l83_i3130_w1;
int temp_l83_i3131_w1;
int temp_l83_i3132_w1;
int temp_l83_i3133_w1;
int temp_l83_i3134_w1;
int temp_l83_i3135_w1;
int temp_l83_i3136_w1;
int temp_l83_i3137_w1;
int temp_l83_i3138_w1;
int temp_l83_i3139_w1;
int temp_l83_i3140_w1;
int temp_l83_i3141_w1;
int temp_l83_i3142_w1;
int temp_l83_i3143_w1;
int temp_l83_i3144_w1;
int temp_l83_i3145_w1;
int temp_l83_i3146_w1;
int temp_l83_i3147_w1;
int temp_l83_i3148_w1;
int temp_l83_i3149_w1;
int temp_l83_i3150_w1;
int temp_l83_i3151_w1;
int temp_l83_i3152_w1;
int temp_l83_i3153_w1;
int temp_l83_i3154_w1;
int temp_l83_i3155_w1;
int temp_l83_i3156_w1;
int temp_l83_i3157_w1;
int temp_l83_i3158_w1;
int temp_l83_i3159_w1;
int temp_l83_i3160_w1;
int temp_l83_i3161_w1;
int temp_l83_i3162_w1;
int temp_l83_i3163_w1;
int temp_l83_i3164_w1;
int temp_l83_i3165_w1;
int temp_l83_i3166_w1;
int temp_l83_i3167_w1;
int temp_l83_i3168_w1;
int temp_l83_i3169_w1;
int temp_l83_i3170_w1;
int temp_l83_i3171_w1;
int temp_l83_i3172_w1;
int temp_l83_i3173_w1;
int temp_l83_i3174_w1;
int temp_l83_i3175_w1;
int temp_l83_i3176_w1;
int temp_l83_i3177_w1;
int temp_l83_i3178_w1;
int temp_l83_i3179_w1;
int temp_l83_i3180_w1;
int temp_l83_i3181_w1;
// Initialization done
// starting Loop
...
temp_l83_i3118_w1 = x[(64)*i] * y[(64)*i];
temp_l83_i3119_w1 = x[(64)*i+1] * y[(64)*i+1];
temp_l83_i3120_w1 = x[(64)*i+2] * y[(64)*i+2];
temp_l83_i3121_w1 = x[(64)*i+3] * y[(64)*i+3];
temp_l83_i3122_w1 = x[(64)*i+4] * y[(64)*i+4];
temp_l83_i3123_w1 = x[(64)*i+5] * y[(64)*i+5];
temp_l83_i3124_w1 = x[(64)*i+6] * y[(64)*i+6];
temp_l83_i3125_w1 = x[(64)*i+7] * y[(64)*i+7];
temp_l83_i3126_w1 = x[(64)*i+8] * y[(64)*i+8];
temp_l83_i3127_w1 = x[(64)*i+9] * y[(64)*i+9];
temp_l83_i3128_w1 = x[(64)*i+10] * y[(64)*i+10];
temp_l83_i3129_w1 = x[(64)*i+11] * y[(64)*i+11];
temp_l83_i3130_w1 = x[(64)*i+12] * y[(64)*i+12];
temp_l83_i3131_w1 = x[(64)*i+13] * y[(64)*i+13];
temp_l83_i3132_w1 = x[(64)*i+14] * y[(64)*i+14];
temp_l83_i3133_w1 = x[(64)*i+15] * y[(64)*i+15];
temp_l83_i3134_w1 = x[(64)*i+16] * y[(64)*i+16];
temp_l83_i3135_w1 = x[(64)*i+17] * y[(64)*i+17];
temp_l83_i3136_w1 = x[(64)*i+18] * y[(64)*i+18];
temp_l83_i3137_w1 = x[(64)*i+19] * y[(64)*i+19];
temp_l83_i3138_w1 = x[(64)*i+20] * y[(64)*i+20];
temp_l83_i3139_w1 = x[(64)*i+21] * y[(64)*i+21];
temp_l83_i3140_w1 = x[(64)*i+22] * y[(64)*i+22];
temp_l83_i3141_w1 = x[(64)*i+23] * y[(64)*i+23];
temp_l83_i3142_w1 = x[(64)*i+24] * y[(64)*i+24];
temp_l83_i3143_w1 = x[(64)*i+25] * y[(64)*i+25];
temp_l83_i3144_w1 = x[(64)*i+26] * y[(64)*i+26];
temp_l83_i3145_w1 = x[(64)*i+27] * y[(64)*i+27];
temp_l83_i3146_w1 = x[(64)*i+28] * y[(64)*i+28];
temp_l83_i3147_w1 = x[(64)*i+29] * y[(64)*i+29];
temp_l83_i3148_w1 = x[(64)*i+30] * y[(64)*i+30];
temp_l83_i3149_w1 = x[(64)*i+31] * y[(64)*i+31];
temp_l83_i3150_w1 = x[(64)*i+32] * y[(64)*i+32];
temp_l83_i3151_w1 = x[(64)*i+33] * y[(64)*i+33];
temp_l83_i3152_w1 = x[(64)*i+34] * y[(64)*i+34];
temp_l83_i3153_w1 = x[(64)*i+35] * y[(64)*i+35];
temp_l83_i3154_w1 = x[(64)*i+36] * y[(64)*i+36];
temp_l83_i3155_w1 = x[(64)*i+37] * y[(64)*i+37];
temp_l83_i3156_w1 = x[(64)*i+38] * y[(64)*i+38];
temp_l83_i3157_w1 = x[(64)*i+39] * y[(64)*i+39];
temp_l83_i3158_w1 = x[(64)*i+40] * y[(64)*i+40];
temp_l83_i3159_w1 = x[(64)*i+41] * y[(64)*i+41];
temp_l83_i3160_w1 = x[(64)*i+42] * y[(64)*i+42];
temp_l83_i3161_w1 = x[(64)*i+43] * y[(64)*i+43];
temp_l83_i3162_w1 = x[(64)*i+44] * y[(64)*i+44];
temp_l83_i3163_w1 = x[(64)*i+45] * y[(64)*i+45];
temp_l83_i3164_w1 = x[(64)*i+46] * y[(64)*i+46];
temp_l83_i3165_w1 = x[(64)*i+47] * y[(64)*i+47];
temp_l83_i3166_w1 = x[(64)*i+48] * y[(64)*i+48];
temp_l83_i3167_w1 = x[(64)*i+49] * y[(64)*i+49];
temp_l83_i3168_w1 = x[(64)*i+50] * y[(64)*i+50];
temp_l83_i3169_w1 = x[(64)*i+51] * y[(64)*i+51];
temp_l83_i3170_w1 = x[(64)*i+52] * y[(64)*i+52];
temp_l83_i3171_w1 = x[(64)*i+53] * y[(64)*i+53];
temp_l83_i3172_w1 = x[(64)*i+54] * y[(64)*i+54];
temp_l83_i3173_w1 = x[(64)*i+55] * y[(64)*i+55];
temp_l83_i3174_w1 = x[(64)*i+56] * y[(64)*i+56];
temp_l83_i3175_w1 = x[(64)*i+57] * y[(64)*i+57];
temp_l83_i3176_w1 = x[(64)*i+58] * y[(64)*i+58];
temp_l83_i3177_w1 = x[(64)*i+59] * y[(64)*i+59];
temp_l83_i3178_w1 = x[(64)*i+60] * y[(64)*i+60];
temp_l83_i3179_w1 = x[(64)*i+61] * y[(64)*i+61];
temp_l83_i3180_w1 = x[(64)*i+62] * y[(64)*i+62];
temp_l83_i3181_w1 = x[(64)*i+63] * y[(64)*i+63];

sum_w27 = temp_l83_i3118_w1 + temp_l83_i3119_w1;
sum_w28 = temp_l83_i3120_w1 + temp_l83_i3121_w1;
sum_w61 = temp_l83_i3122_w1 + temp_l83_i3123_w1;
sum_w62 = temp_l83_i3124_w1 + temp_l83_i3125_w1;
sum_w31 = temp_l83_i3126_w1 + temp_l83_i3127_w1;
sum_w32 = temp_l83_i3128_w1 + temp_l83_i3129_w1;
sum_w21 = temp_l83_i3130_w1 + temp_l83_i3131_w1;
sum_w22 = temp_l83_i3132_w1 + temp_l83_i3133_w1;
sum_w37 = temp_l83_i3134_w1 + temp_l83_i3135_w1;
sum_w38 = temp_l83_i3136_w1 + temp_l83_i3137_w1;
sum_w45 = temp_l83_i3138_w1 + temp_l83_i3139_w1;
sum_w46 = temp_l83_i3140_w1 + temp_l83_i3141_w1;
sum_w15 = temp_l83_i3142_w1 + temp_l83_i3143_w1;
sum_w16 = temp_l83_i3144_w1 + temp_l83_i3145_w1;
sum_w1 = temp_l83_i3146_w1 + temp_l83_i3147_w1;
sum_w2 = temp_l83_i3148_w1 + temp_l83_i3149_w1;
sum_w49 = temp_l83_i3150_w1 + temp_l83_i3151_w1;
sum_w50 = temp_l83_i3152_w1 + temp_l83_i3153_w1;
sum_w23 = temp_l83_i3154_w1 + temp_l83_i3155_w1;
sum_w24 = temp_l83_i3156_w1 + temp_l83_i3157_w1;
sum_w35 = temp_l83_i3158_w1 + temp_l83_i3159_w1;
sum_w36 = temp_l83_i3160_w1 + temp_l83_i3161_w1;
sum_w9 = temp_l83_i3162_w1 + temp_l83_i3163_w1;
sum_w10 = temp_l83_i3164_w1 + temp_l83_i3165_w1;
sum_w57 = temp_l83_i3166_w1 + temp_l83_i3167_w1;
sum_w58 = temp_l83_i3168_w1 + temp_l83_i3169_w1;
sum_w51 = temp_l83_i3170_w1 + temp_l83_i3171_w1;
sum_w52 = temp_l83_i3172_w1 + temp_l83_i3173_w1;
sum_w5 = temp_l83_i3174_w1 + temp_l83_i3175_w1;
sum_w6 = temp_l83_i3176_w1 + temp_l83_i3177_w1;
sum_w29 = temp_l83_i3178_w1 + temp_l83_i3179_w1;
sum_w30 = temp_l83_i3180_w1 + temp_l83_i3181_w1;

sum_w54 = sum_w1 + sum_w2;
sum_w53 = sum_w15 + sum_w16;
sum_w44 = sum_w21 + sum_w22;
sum_w14 = sum_w23 + sum_w24;
sum_w11 = sum_w27 + sum_w28;
sum_w26 = sum_w29 + sum_w30;
sum_w43 = sum_w31 + sum_w32;
sum_w3 = sum_w35 + sum_w36;
sum_w7 = sum_w37 + sum_w38;
sum_w8 = sum_w45 + sum_w46;
sum_w13 = sum_w49 + sum_w50;
sum_w25 = sum_w5 + sum_w6;
sum_w48 = sum_w51 + sum_w52;
sum_w47 = sum_w57 + sum_w58;
sum_w12 = sum_w61 + sum_w62;
sum_w4 = sum_w9 + sum_w10;

sum_w19 = sum_w11 + sum_w12;
sum_w55 = sum_w13 + sum_w14;
sum_w34 = sum_w25 + sum_w26;
sum_w56 = sum_w3 + sum_w4;
sum_w20 = sum_w43 + sum_w44;
sum_w33 = sum_w47 + sum_w48;
sum_w40 = sum_w53 + sum_w54;
sum_w39 = sum_w7 + sum_w8;

sum_w59 = sum_w19 + sum_w20;
sum_w18 = sum_w33 + sum_w34;
sum_w60 = sum_w39 + sum_w40;
sum_w17 = sum_w55 + sum_w56;

sum_w42 = sum_w17 + sum_w18;
sum_w41 = sum_w59 + sum_w60;

sum_array[i] = sum_w41 + sum_w42;

}
}

void epilogue(int sum_array_3[13], int sum_array_2[16], short x_0[45], short y_0[45], short y_5[51], int sum_array_1[16], short x_5[51], int sum_array_0[16], int *out) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w100;
...
void n4000_dotprod_parallel4(short x_0[45], short x_1[1024], short x_2[1024], short x_3[1024], short x_4[832], short x_5[51], short y_0[45], short y_1[1024], short y_2[1024], short y_3[1024], short y_4[832], short y_5[51], int *out) {
// Step 2: Initialize local variables
int sum_array_0[16];
int sum_array_1[16];
int sum_array_2[16];
...
parallel_1(x_4,y_4,sum_array_3);
