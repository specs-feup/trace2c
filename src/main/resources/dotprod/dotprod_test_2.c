...
#pragma HLS ARRAY_PARTITION variable=y_1 cyclic factor=992 dim=0
#pragma HLS ARRAY_PARTITION variable=y_2 cyclic factor=992 dim=0
...
#pragma HLS ARRAY_PARTITION variable=x_1 cyclic factor=992 dim=0
#pragma HLS ARRAY_PARTITION variable=x_2 cyclic factor=992 dim=0
#pragma HLS ARRAY_PARTITION variable=x_3 cyclic factor=3 dim=0
#pragma HLS ARRAY_PARTITION variable=sum_array_0 cyclic factor=62 dim=0
#pragma HLS ARRAY_PARTITION variable=sum_array_1 cyclic factor=62 dim=0
// Initialization done
#pragma HLS dataflow
