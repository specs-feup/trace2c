...
void parallel_0(short x[496], short y[496], int sum_array[31]) {
...
void epilogue(int sum_array_3[31], int sum_array_2[31], short x_0[13], short y_0[13], short y_5[3], int sum_array_1[31], short x_5[3], int sum_array_0[31], int *out) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w100;
...
sum_w37 = sum_array_0[30] + sum_array_1[0];
sum_w38 = sum_array_1[1] + sum_array_1[2];
sum_w3 = sum_array_1[3] + sum_array_1[4];
sum_w4 = sum_array_1[5] + sum_array_1[6];
sum_w118 = sum_array_1[7] + sum_array_1[8];
sum_w119 = sum_array_1[9] + sum_array_1[10];
sum_w132 = sum_array_1[11] + sum_array_1[12];
sum_w133 = sum_array_1[13] + sum_array_1[14];
sum_w106 = sum_array_1[15] + sum_array_1[16];
sum_w107 = sum_array_1[17] + sum_array_1[18];
sum_w82 = sum_array_1[19] + sum_array_1[20];
sum_w83 = sum_array_1[21] + sum_array_1[22];
sum_w100 = sum_array_1[23] + sum_array_1[24];
sum_w101 = sum_array_1[25] + sum_array_1[26];
sum_w27 = sum_array_1[27] + sum_array_1[28];
sum_w28 = sum_array_1[29] + sum_array_1[30];
sum_w84 = sum_array_2[0] + sum_array_2[1];
sum_w85 = sum_array_2[2] + sum_array_2[3];
sum_w41 = sum_array_2[4] + sum_array_2[5];
sum_w42 = sum_array_2[6] + sum_array_2[7];
sum_w39 = sum_array_2[8] + sum_array_2[9];
sum_w40 = sum_array_2[10] + sum_array_2[11];
sum_w35 = sum_array_2[12] + sum_array_2[13];
sum_w36 = sum_array_2[14] + sum_array_2[15];
sum_w49 = sum_array_2[16] + sum_array_2[17];
sum_w50 = sum_array_2[18] + sum_array_2[19];
sum_w112 = sum_array_2[20] + sum_array_2[21];
sum_w113 = sum_array_2[22] + sum_array_2[23];
sum_w63 = sum_array_2[24] + sum_array_2[25];
sum_w64 = sum_array_2[26] + sum_array_2[27];
sum_w55 = sum_array_2[28] + sum_array_2[29];
sum_w56 = sum_array_2[30] + sum_array_3[0];
sum_w77 = sum_array_3[1] + sum_array_3[2];
sum_w78 = sum_array_3[3] + sum_array_3[4];
sum_w53 = sum_array_3[5] + sum_array_3[6];
sum_w54 = sum_array_3[7] + sum_array_3[8];
sum_w88 = sum_array_3[9] + sum_array_3[10];
sum_w89 = sum_array_3[11] + sum_array_3[12];
sum_w5 = sum_array_3[13] + sum_array_3[14];
sum_w6 = sum_array_3[15] + sum_array_3[16];
sum_w17 = sum_array_3[17] + sum_array_3[18];
sum_w18 = sum_array_3[19] + sum_array_3[20];
sum_w13 = sum_array_3[21] + sum_array_3[22];
sum_w14 = sum_array_3[23] + sum_array_3[24];
sum_w45 = sum_array_3[25] + sum_array_3[26];
sum_w46 = sum_array_3[27] + sum_array_3[28];
sum_w16 = sum_array_3[29] + sum_array_3[30];
...
temp_l83_i1998_w1 = x_5[0] * y_5[0];
temp_l83_i1999_w1 = x_5[1] * y_5[1];
temp_l83_i2000_w1 = x_5[2] * y_5[2];
...
void dotprod_parallel4(short y_0[13], short y_1[496], short y_2[496], short y_3[496], short y_4[496], short y_5[3], short x_0[13], short x_1[496], short x_2[496], short x_3[496], short x_4[496], short x_5[3], int *out) {
// Step 2: Initialize local variables
int sum_array_0[31];
int sum_array_1[31];
int sum_array_2[31];
...
#pragma HLS ARRAY_PARTITION variable=y_1 cyclic factor=496 dim=0
#pragma HLS ARRAY_PARTITION variable=y_2 cyclic factor=496 dim=0
#pragma HLS ARRAY_PARTITION variable=y_3 cyclic factor=496 dim=0
#pragma HLS ARRAY_PARTITION variable=y_4 cyclic factor=496 dim=0
#pragma HLS ARRAY_PARTITION variable=y_5 cyclic factor=3 dim=0
#pragma HLS ARRAY_PARTITION variable=x_0 cyclic factor=13 dim=0
#pragma HLS ARRAY_PARTITION variable=x_1 cyclic factor=496 dim=0
#pragma HLS ARRAY_PARTITION variable=x_2 cyclic factor=496 dim=0
#pragma HLS ARRAY_PARTITION variable=x_3 cyclic factor=496 dim=0
#pragma HLS ARRAY_PARTITION variable=x_4 cyclic factor=496 dim=0
#pragma HLS ARRAY_PARTITION variable=x_5 cyclic factor=3 dim=0
#pragma HLS ARRAY_PARTITION variable=sum_array_0 cyclic factor=31 dim=0
#pragma HLS ARRAY_PARTITION variable=sum_array_1 cyclic factor=31 dim=0
#pragma HLS ARRAY_PARTITION variable=sum_array_2 cyclic factor=31 dim=0
#pragma HLS ARRAY_PARTITION variable=sum_array_3 cyclic factor=31 dim=0
// Initialization done
#pragma HLS dataflow
...
epilogue(sum_array_3,sum_array_2,x_0,y_0,y_5,sum_array_1,x_5,sum_array_0,out);
