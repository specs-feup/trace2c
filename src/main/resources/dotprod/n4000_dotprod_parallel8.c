...
void parallel_0(short x[512], short y[512], int sum_array[8]) {
...
void parallel_1(short x[320], short y[320], int sum_array[5]) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w11;
...
int sum_w8;
int sum_w9;
int temp_l83_i3630_w1;
int temp_l83_i3631_w1;
int temp_l83_i3632_w1;
int temp_l83_i3633_w1;
int temp_l83_i3634_w1;
int temp_l83_i3635_w1;
int temp_l83_i3636_w1;
int temp_l83_i3637_w1;
int temp_l83_i3638_w1;
int temp_l83_i3639_w1;
int temp_l83_i3640_w1;
int temp_l83_i3641_w1;
int temp_l83_i3642_w1;
int temp_l83_i3643_w1;
int temp_l83_i3644_w1;
int temp_l83_i3645_w1;
int temp_l83_i3646_w1;
int temp_l83_i3647_w1;
int temp_l83_i3648_w1;
int temp_l83_i3649_w1;
int temp_l83_i3650_w1;
int temp_l83_i3651_w1;
int temp_l83_i3652_w1;
int temp_l83_i3653_w1;
int temp_l83_i3654_w1;
int temp_l83_i3655_w1;
int temp_l83_i3656_w1;
int temp_l83_i3657_w1;
int temp_l83_i3658_w1;
int temp_l83_i3659_w1;
int temp_l83_i3660_w1;
int temp_l83_i3661_w1;
int temp_l83_i3662_w1;
int temp_l83_i3663_w1;
int temp_l83_i3664_w1;
int temp_l83_i3665_w1;
int temp_l83_i3666_w1;
int temp_l83_i3667_w1;
int temp_l83_i3668_w1;
int temp_l83_i3669_w1;
int temp_l83_i3670_w1;
int temp_l83_i3671_w1;
int temp_l83_i3672_w1;
int temp_l83_i3673_w1;
int temp_l83_i3674_w1;
int temp_l83_i3675_w1;
int temp_l83_i3676_w1;
int temp_l83_i3677_w1;
int temp_l83_i3678_w1;
int temp_l83_i3679_w1;
int temp_l83_i3680_w1;
int temp_l83_i3681_w1;
int temp_l83_i3682_w1;
int temp_l83_i3683_w1;
int temp_l83_i3684_w1;
int temp_l83_i3685_w1;
int temp_l83_i3686_w1;
int temp_l83_i3687_w1;
int temp_l83_i3688_w1;
int temp_l83_i3689_w1;
int temp_l83_i3690_w1;
int temp_l83_i3691_w1;
int temp_l83_i3692_w1;
int temp_l83_i3693_w1;
// Initialization done
// starting Loop
...
temp_l83_i3630_w1 = x[(64)*i] * y[(64)*i];
temp_l83_i3631_w1 = x[(64)*i+1] * y[(64)*i+1];
temp_l83_i3632_w1 = x[(64)*i+2] * y[(64)*i+2];
temp_l83_i3633_w1 = x[(64)*i+3] * y[(64)*i+3];
temp_l83_i3634_w1 = x[(64)*i+4] * y[(64)*i+4];
temp_l83_i3635_w1 = x[(64)*i+5] * y[(64)*i+5];
temp_l83_i3636_w1 = x[(64)*i+6] * y[(64)*i+6];
temp_l83_i3637_w1 = x[(64)*i+7] * y[(64)*i+7];
temp_l83_i3638_w1 = x[(64)*i+8] * y[(64)*i+8];
temp_l83_i3639_w1 = x[(64)*i+9] * y[(64)*i+9];
temp_l83_i3640_w1 = x[(64)*i+10] * y[(64)*i+10];
temp_l83_i3641_w1 = x[(64)*i+11] * y[(64)*i+11];
temp_l83_i3642_w1 = x[(64)*i+12] * y[(64)*i+12];
temp_l83_i3643_w1 = x[(64)*i+13] * y[(64)*i+13];
temp_l83_i3644_w1 = x[(64)*i+14] * y[(64)*i+14];
temp_l83_i3645_w1 = x[(64)*i+15] * y[(64)*i+15];
temp_l83_i3646_w1 = x[(64)*i+16] * y[(64)*i+16];
temp_l83_i3647_w1 = x[(64)*i+17] * y[(64)*i+17];
temp_l83_i3648_w1 = x[(64)*i+18] * y[(64)*i+18];
temp_l83_i3649_w1 = x[(64)*i+19] * y[(64)*i+19];
temp_l83_i3650_w1 = x[(64)*i+20] * y[(64)*i+20];
temp_l83_i3651_w1 = x[(64)*i+21] * y[(64)*i+21];
temp_l83_i3652_w1 = x[(64)*i+22] * y[(64)*i+22];
temp_l83_i3653_w1 = x[(64)*i+23] * y[(64)*i+23];
temp_l83_i3654_w1 = x[(64)*i+24] * y[(64)*i+24];
temp_l83_i3655_w1 = x[(64)*i+25] * y[(64)*i+25];
temp_l83_i3656_w1 = x[(64)*i+26] * y[(64)*i+26];
temp_l83_i3657_w1 = x[(64)*i+27] * y[(64)*i+27];
temp_l83_i3658_w1 = x[(64)*i+28] * y[(64)*i+28];
temp_l83_i3659_w1 = x[(64)*i+29] * y[(64)*i+29];
temp_l83_i3660_w1 = x[(64)*i+30] * y[(64)*i+30];
temp_l83_i3661_w1 = x[(64)*i+31] * y[(64)*i+31];
temp_l83_i3662_w1 = x[(64)*i+32] * y[(64)*i+32];
temp_l83_i3663_w1 = x[(64)*i+33] * y[(64)*i+33];
temp_l83_i3664_w1 = x[(64)*i+34] * y[(64)*i+34];
temp_l83_i3665_w1 = x[(64)*i+35] * y[(64)*i+35];
temp_l83_i3666_w1 = x[(64)*i+36] * y[(64)*i+36];
temp_l83_i3667_w1 = x[(64)*i+37] * y[(64)*i+37];
temp_l83_i3668_w1 = x[(64)*i+38] * y[(64)*i+38];
temp_l83_i3669_w1 = x[(64)*i+39] * y[(64)*i+39];
temp_l83_i3670_w1 = x[(64)*i+40] * y[(64)*i+40];
temp_l83_i3671_w1 = x[(64)*i+41] * y[(64)*i+41];
temp_l83_i3672_w1 = x[(64)*i+42] * y[(64)*i+42];
temp_l83_i3673_w1 = x[(64)*i+43] * y[(64)*i+43];
temp_l83_i3674_w1 = x[(64)*i+44] * y[(64)*i+44];
temp_l83_i3675_w1 = x[(64)*i+45] * y[(64)*i+45];
temp_l83_i3676_w1 = x[(64)*i+46] * y[(64)*i+46];
temp_l83_i3677_w1 = x[(64)*i+47] * y[(64)*i+47];
temp_l83_i3678_w1 = x[(64)*i+48] * y[(64)*i+48];
temp_l83_i3679_w1 = x[(64)*i+49] * y[(64)*i+49];
temp_l83_i3680_w1 = x[(64)*i+50] * y[(64)*i+50];
temp_l83_i3681_w1 = x[(64)*i+51] * y[(64)*i+51];
temp_l83_i3682_w1 = x[(64)*i+52] * y[(64)*i+52];
temp_l83_i3683_w1 = x[(64)*i+53] * y[(64)*i+53];
temp_l83_i3684_w1 = x[(64)*i+54] * y[(64)*i+54];
temp_l83_i3685_w1 = x[(64)*i+55] * y[(64)*i+55];
temp_l83_i3686_w1 = x[(64)*i+56] * y[(64)*i+56];
temp_l83_i3687_w1 = x[(64)*i+57] * y[(64)*i+57];
temp_l83_i3688_w1 = x[(64)*i+58] * y[(64)*i+58];
temp_l83_i3689_w1 = x[(64)*i+59] * y[(64)*i+59];
temp_l83_i3690_w1 = x[(64)*i+60] * y[(64)*i+60];
temp_l83_i3691_w1 = x[(64)*i+61] * y[(64)*i+61];
temp_l83_i3692_w1 = x[(64)*i+62] * y[(64)*i+62];
temp_l83_i3693_w1 = x[(64)*i+63] * y[(64)*i+63];

sum_w47 = temp_l83_i3630_w1 + temp_l83_i3631_w1;
sum_w48 = temp_l83_i3632_w1 + temp_l83_i3633_w1;
sum_w61 = temp_l83_i3634_w1 + temp_l83_i3635_w1;
sum_w62 = temp_l83_i3636_w1 + temp_l83_i3637_w1;
sum_w35 = temp_l83_i3638_w1 + temp_l83_i3639_w1;
sum_w36 = temp_l83_i3640_w1 + temp_l83_i3641_w1;
sum_w33 = temp_l83_i3642_w1 + temp_l83_i3643_w1;
sum_w34 = temp_l83_i3644_w1 + temp_l83_i3645_w1;
sum_w1 = temp_l83_i3646_w1 + temp_l83_i3647_w1;
sum_w2 = temp_l83_i3648_w1 + temp_l83_i3649_w1;
sum_w51 = temp_l83_i3650_w1 + temp_l83_i3651_w1;
sum_w52 = temp_l83_i3652_w1 + temp_l83_i3653_w1;
sum_w9 = temp_l83_i3654_w1 + temp_l83_i3655_w1;
sum_w10 = temp_l83_i3656_w1 + temp_l83_i3657_w1;
sum_w55 = temp_l83_i3658_w1 + temp_l83_i3659_w1;
sum_w56 = temp_l83_i3660_w1 + temp_l83_i3661_w1;
sum_w41 = temp_l83_i3662_w1 + temp_l83_i3663_w1;
sum_w42 = temp_l83_i3664_w1 + temp_l83_i3665_w1;
sum_w11 = temp_l83_i3666_w1 + temp_l83_i3667_w1;
sum_w12 = temp_l83_i3668_w1 + temp_l83_i3669_w1;
sum_w5 = temp_l83_i3670_w1 + temp_l83_i3671_w1;
sum_w6 = temp_l83_i3672_w1 + temp_l83_i3673_w1;
sum_w37 = temp_l83_i3674_w1 + temp_l83_i3675_w1;
sum_w38 = temp_l83_i3676_w1 + temp_l83_i3677_w1;
sum_w25 = temp_l83_i3678_w1 + temp_l83_i3679_w1;
sum_w26 = temp_l83_i3680_w1 + temp_l83_i3681_w1;
sum_w23 = temp_l83_i3682_w1 + temp_l83_i3683_w1;
sum_w24 = temp_l83_i3684_w1 + temp_l83_i3685_w1;
sum_w57 = temp_l83_i3686_w1 + temp_l83_i3687_w1;
sum_w58 = temp_l83_i3688_w1 + temp_l83_i3689_w1;
sum_w17 = temp_l83_i3690_w1 + temp_l83_i3691_w1;
sum_w18 = temp_l83_i3692_w1 + temp_l83_i3693_w1;

sum_w27 = sum_w1 + sum_w2;
sum_w8 = sum_w11 + sum_w12;
sum_w32 = sum_w17 + sum_w18;
sum_w14 = sum_w23 + sum_w24;
sum_w13 = sum_w25 + sum_w26;
sum_w22 = sum_w33 + sum_w34;
sum_w21 = sum_w35 + sum_w36;
sum_w20 = sum_w37 + sum_w38;
sum_w7 = sum_w41 + sum_w42;
sum_w3 = sum_w47 + sum_w48;
sum_w19 = sum_w5 + sum_w6;
sum_w28 = sum_w51 + sum_w52;
sum_w40 = sum_w55 + sum_w56;
sum_w31 = sum_w57 + sum_w58;
sum_w4 = sum_w61 + sum_w62;
sum_w39 = sum_w9 + sum_w10;

sum_w43 = sum_w13 + sum_w14;
sum_w60 = sum_w19 + sum_w20;
sum_w50 = sum_w21 + sum_w22;
sum_w45 = sum_w27 + sum_w28;
sum_w49 = sum_w3 + sum_w4;
sum_w44 = sum_w31 + sum_w32;
sum_w46 = sum_w39 + sum_w40;
sum_w59 = sum_w7 + sum_w8;

sum_w30 = sum_w43 + sum_w44;
sum_w16 = sum_w45 + sum_w46;
sum_w15 = sum_w49 + sum_w50;
sum_w29 = sum_w59 + sum_w60;

sum_w53 = sum_w15 + sum_w16;
sum_w54 = sum_w29 + sum_w30;

sum_array[i] = sum_w53 + sum_w54;

}
}

void epilogue(int sum_array_3[8], int sum_array_2[8], short y_9[51], int sum_array_5[8], int sum_array_4[8], short x_9[51], int sum_array_7[5], int sum_array_6[8], short x_0[45], short y_0[45], int sum_array_1[8], int sum_array_0[8], int *out) {
// Step 2: Initialize local variables
int sum_w1;
int sum_w10;
int sum_w100;
...
sum_w35 = sum_array_1[0] + sum_array_1[1];
sum_w36 = sum_array_1[2] + sum_array_1[3];
sum_w106 = sum_array_1[4] + sum_array_1[5];
sum_w107 = sum_array_1[6] + sum_array_1[7];
sum_w80 = sum_array_2[0] + sum_array_2[1];
sum_w81 = sum_array_2[2] + sum_array_2[3];
sum_w43 = sum_array_2[4] + sum_array_2[5];
sum_w44 = sum_array_2[6] + sum_array_2[7];
sum_w15 = sum_array_3[0] + sum_array_3[1];
sum_w16 = sum_array_3[2] + sum_array_3[3];
sum_w82 = sum_array_3[4] + sum_array_3[5];
sum_w83 = sum_array_3[6] + sum_array_3[7];
sum_w41 = sum_array_4[0] + sum_array_4[1];
sum_w42 = sum_array_4[2] + sum_array_4[3];
sum_w31 = sum_array_4[4] + sum_array_4[5];
sum_w32 = sum_array_4[6] + sum_array_4[7];
sum_w115 = sum_array_5[0] + sum_array_5[1];
sum_w116 = sum_array_5[2] + sum_array_5[3];
sum_w113 = sum_array_5[4] + sum_array_5[5];
sum_w114 = sum_array_5[6] + sum_array_5[7];
sum_w125 = sum_array_6[0] + sum_array_6[1];
sum_w126 = sum_array_6[2] + sum_array_6[3];
sum_w104 = sum_array_6[4] + sum_array_6[5];
sum_w105 = sum_array_6[6] + sum_array_6[7];
sum_w29 = sum_array_7[0] + sum_array_7[1];
sum_w30 = sum_array_7[2] + sum_array_7[3];
...
temp_l83_i3950_w1 = x_9[0] * y_9[0];
temp_l83_i3951_w1 = x_9[1] * y_9[1];
temp_l83_i3952_w1 = x_9[2] * y_9[2];
temp_l83_i3953_w1 = x_9[3] * y_9[3];
temp_l83_i3954_w1 = x_9[4] * y_9[4];
temp_l83_i3955_w1 = x_9[5] * y_9[5];
temp_l83_i3956_w1 = x_9[6] * y_9[6];
temp_l83_i3957_w1 = x_9[7] * y_9[7];
temp_l83_i3958_w1 = x_9[8] * y_9[8];
temp_l83_i3959_w1 = x_9[9] * y_9[9];
temp_l83_i3960_w1 = x_9[10] * y_9[10];
temp_l83_i3961_w1 = x_9[11] * y_9[11];
temp_l83_i3962_w1 = x_9[12] * y_9[12];
temp_l83_i3963_w1 = x_9[13] * y_9[13];
temp_l83_i3964_w1 = x_9[14] * y_9[14];
temp_l83_i3965_w1 = x_9[15] * y_9[15];
temp_l83_i3966_w1 = x_9[16] * y_9[16];
temp_l83_i3967_w1 = x_9[17] * y_9[17];
temp_l83_i3968_w1 = x_9[18] * y_9[18];
temp_l83_i3969_w1 = x_9[19] * y_9[19];
temp_l83_i3970_w1 = x_9[20] * y_9[20];
temp_l83_i3971_w1 = x_9[21] * y_9[21];
temp_l83_i3972_w1 = x_9[22] * y_9[22];
temp_l83_i3973_w1 = x_9[23] * y_9[23];
temp_l83_i3974_w1 = x_9[24] * y_9[24];
temp_l83_i3975_w1 = x_9[25] * y_9[25];
temp_l83_i3976_w1 = x_9[26] * y_9[26];
temp_l83_i3977_w1 = x_9[27] * y_9[27];
temp_l83_i3978_w1 = x_9[28] * y_9[28];
temp_l83_i3979_w1 = x_9[29] * y_9[29];
temp_l83_i3980_w1 = x_9[30] * y_9[30];
temp_l83_i3981_w1 = x_9[31] * y_9[31];
temp_l83_i3982_w1 = x_9[32] * y_9[32];
temp_l83_i3983_w1 = x_9[33] * y_9[33];
temp_l83_i3984_w1 = x_9[34] * y_9[34];
temp_l83_i3985_w1 = x_9[35] * y_9[35];
temp_l83_i3986_w1 = x_9[36] * y_9[36];
temp_l83_i3987_w1 = x_9[37] * y_9[37];
temp_l83_i3988_w1 = x_9[38] * y_9[38];
temp_l83_i3989_w1 = x_9[39] * y_9[39];
temp_l83_i3990_w1 = x_9[40] * y_9[40];
temp_l83_i3991_w1 = x_9[41] * y_9[41];
temp_l83_i3992_w1 = x_9[42] * y_9[42];
temp_l83_i3993_w1 = x_9[43] * y_9[43];
temp_l83_i3994_w1 = x_9[44] * y_9[44];
temp_l83_i3995_w1 = x_9[45] * y_9[45];
temp_l83_i3996_w1 = x_9[46] * y_9[46];
temp_l83_i3997_w1 = x_9[47] * y_9[47];
temp_l83_i3998_w1 = x_9[48] * y_9[48];
temp_l83_i3999_w1 = x_9[49] * y_9[49];
temp_l83_i4000_w1 = x_9[50] * y_9[50];
...
void n4000_dotprod_parallel8(short x_0[45], short x_1[512], short x_2[512], short x_3[512], short x_4[512], short x_5[512], short x_6[512], short x_7[512], short x_8[320], short x_9[51], short y_0[45], short y_1[512], short y_2[512], short y_3[512], short y_4[512], short y_5[512], short y_6[512], short y_7[512], short y_8[320], short y_9[51], int *out) {
// Step 2: Initialize local variables
int sum_array_0[8];
int sum_array_1[8];
int sum_array_2[8];
...
#pragma HLS ARRAY_PARTITION variable=x_7 cyclic factor=64 dim=0
#pragma HLS ARRAY_PARTITION variable=x_8 cyclic factor=64 dim=0
#pragma HLS ARRAY_PARTITION variable=x_9 cyclic factor=51 dim=0
...
#pragma HLS ARRAY_PARTITION variable=y_7 cyclic factor=64 dim=0
#pragma HLS ARRAY_PARTITION variable=y_8 cyclic factor=64 dim=0
#pragma HLS ARRAY_PARTITION variable=y_9 cyclic factor=51 dim=0
...
epilogue(sum_array_3,sum_array_2,y_9,sum_array_5,sum_array_4,x_9,sum_array_7,sum_array_6,x_0,y_0,sum_array_1,sum_array_0,out);
